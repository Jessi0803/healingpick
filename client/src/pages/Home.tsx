...
const testimonials = [
  {
    text: '前陣子我整個人很卡，很多事想不清楚。抽完牌之後不是突然什麼都解決了，但至少有種「我終於知道自己在糾結什麼」的感覺，心也比較定下來。',
    name: '小雨',
    tag: '塔羅 × 心靈樹洞',
    crystal: '紫水晶',
  },
  {
    text: '原本只是抱著好奇來看命盤，結果裡面講到的幾個性格真的有中。那種「原來我會這樣想、這樣反應，不是沒有原因」的感覺，還滿被安慰到的。',
    name: 'Mia',
    tag: '紫微斗數 × 能量商品',
    crystal: '粉晶',
  },
  {
    text: '我現在幾乎每天早上都會先看一下今日運勢。它不是那種很浮誇的內容，比較像有人輕輕提醒你今天的節奏，忙的時候看一眼，心情會穩很多。',
    name: '阿哲',
    tag: '每日運勢',
    crystal: '黃水晶',
  },
