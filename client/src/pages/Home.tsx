...
export default function Home() {
  ...
  return (
    <PageLayout>
      ...
      {/* ── ABOUT US SECTION ────────────────────────────────────────────── */}
      <section id="about" className="py-24 px-6 md:px-10 relative overflow-hidden bg-gradient-to-b from-[#FAF7F4] via-[#F2EDE8]/30 to-[#FAF7F4]">
        {/* Soft floating particles / sparkles */}
        <div className="absolute top-[20%] left-[5%] w-2 h-2 rounded-full bg-[#D1BE9B]/20 animate-pulse pointer-events-none" />
        <div className="absolute bottom-[30%] right-[5%] w-3 h-3 rounded-full bg-[#D1BE9B]/15 animate-pulse pointer-events-none" style={{ animationDelay: '1.5s' }} />
        
        {/* Watermark brand background */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none opacity-[0.015] text-[15vw] tracking-[0.25em] font-light text-[#31353A] whitespace-nowrap"
          style={{ fontFamily: 'Cormorant Garamond, serif' }}>
          HEALING PICK
        </div>
        ...
        <div className="max-w-3xl mx-auto z-10 relative">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <h2 className="text-2xl md:text-3xl tracking-[0.2em] font-extralight text-[#31353A] mt-3 mb-2"
              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
              關於 HealingPick
            </h2>
            <div className="divider-gold mt-4 max-w-xs mx-auto">
          ...
          {/* Poetry story block */}
          <div className="space-y-10 text-center mb-16 animate-fade-in-up">
          ...
          <div className="text-center max-w-xl mx-auto space-y-6 border-t border-[#D1BE9B]/15 pt-12 animate-fade-in-up">
