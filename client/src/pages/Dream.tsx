        ...
        <div className="min-w-0 flex-1">
          <div className="mb-2 flex items-start justify-between gap-2">
            <div className="min-w-0">
              <span
                className="mr-1.5 rounded-full border border-[#D1BE9B]/20 bg-white/70 px-1.5 py-0.5 text-[10px] tracking-[0.15em] text-[#6F5A3A]"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {roleLabel}
              </span>
              {product.tag && (
                <span
                  className="rounded-full bg-[#D1BE9B]/20 px-1.5 py-0.5 text-[10px] tracking-[0.15em] text-[#A38D6B]"
                  style={{
              ...
              <p
                className="mt-1 truncate text-[15px] tracking-[0.08em] text-[#31353A]/88"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {product.name}
              </p>
            ...
            <p
              className="flex-shrink-0 text-sm font-light text-[#D1BE9B]"
              style={{ fontFamily: "Cormorant Garamond, serif" }}
            >
              NT$ {product.price.toLocaleString()}
            </p>
          ...
          <div className="mb-2 flex flex-wrap gap-1">
            {meanings.map(meaning => (
              <span
                key={meaning}
                className="rounded-full border border-[#D1BE9B]/15 bg-[#F0EBE3]/70 px-2 py-0.5 text-[10px] tracking-[0.1em] text-[#31353A]/62"
                style={{
                  fontFamily: "Noto Sans TC, sans-serif",
                  fontWeight: 300,
                }}
          ...
          <div className="mb-2 rounded-xl border border-[#D1BE9B]/15 bg-[#F8F4EC]/45 px-3 py-2">
            <p
              className="mb-1 text-[11px] tracking-[0.18em] text-[#A38D6B]"
              style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
            >
              為什麼 Mochi 想到它
            </p>
            <p
              className="text-[12px] leading-[1.85] tracking-[0.06em] text-[#31353A]/66"
              style={{
                fontFamily: "Noto Sans TC, sans-serif",
                fontWeight: 300,
              }}
...
export default function DreamPage() {
  ...
  const interpretMutation = trpc.dream.interpret.useMutation({
    ...
    onError: error => {
      if (
        ...
        error.message === "ANON_QUOTA_EXHAUSTED"
      ) {
      ...
      if (error.message === "INSUFFICIENT_CREDITS") {
        toast.error("可用次數不足", {
          description: "可以先購買點數，再回來找 Mochi 解夢。",
        });
        return;
      }
  ...
  const waitingMessage = useRotatingText(
    DREAM_WAITING_MESSAGES,
  ...
  const submitFollowUp = useCallback(
    (trimmedQuestion: string) => {
      if (!trimmedQuestion || !interpretation || followUpMutation.isPending)
        return false;
    ...
    [dreamContent, followUpMutation, interpretation, isAuthenticated, login]
  );
      ...
      <main className="relative min-h-screen overflow-hidden px-4 pb-20 pt-28 md:px-8">
        ...
        <section className="relative z-10 mx-auto flex max-w-6xl flex-col gap-8 lg:grid lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          ...
          <div className="relative z-10 pt-6 lg:sticky lg:top-32">
            <div
              className="mb-8 inline-flex items-center gap-2 rounded-full border border-[#D1BE9B]/25 bg-white/40 px-4 py-2 text-[11px] tracking-[0.18em] text-[#8A7250] shadow-[0_8px_28px_rgba(209,190,155,0.12)] backdrop-blur-sm"
              style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
            >
            ...
            <div className="relative mb-7 flex items-end gap-4">
              <div>
                <p
                  className="mb-3 text-[11px] tracking-[0.35em] text-[#D1BE9B]"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
                ...
                <h1
                  className="text-2xl font-extralight leading-[1.65] tracking-[0.16em] text-[#31353A] md:text-4xl"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
            ...
            <p
              className="max-w-md text-[13px] leading-[2.2] tracking-[0.12em] text-[#31353A]/62"
              style={{
                fontFamily: "Noto Sans TC, sans-serif",
                fontWeight: 300,
              }}
          ...
          <div className="relative z-10">
            ...
            >
              <label className="block">
                <span
                  className="mb-2 block text-[12px] tracking-[0.22em] text-[#8A7250]"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 300,
                  }}
                ...
                <Textarea
                  value={dreamContent}
                  onChange={event =>
                    setDreamContent(event.target.value.slice(0, 1600))
                  }
                ...
                />
                <span
                  className={`mt-2 block text-right text-[10px] tracking-[0.12em] ${remainingChars < 80 ? "text-[#C9837A]" : "text-[#31353A]/35"}`}
                  style={{
                    fontFamily: "Noto Sans TC, sans-serif",
                    fontWeight: 300,
                  }}
            ...
            {(interpretMutation.isPending || interpretation) && (
              <section className="relative overflow-hidden mt-6 rounded-2xl border border-[#D1BE9B]/22 bg-white/58 p-5 shadow-[0_18px_50px_rgba(163,141,107,0.1)] backdrop-blur-xl md:p-7">
                ...
                {interpretMutation.isPending ? (
                  ...
                  >
                    <p
                      className="text-[13px] leading-[2.2] tracking-[0.12em] text-[#31353A]/54"
                      style={{
                        fontFamily: "Noto Sans TC, sans-serif",
                        fontWeight: 300,
                      }}
                  ...
                  <div
                    ...
                    className="animate-fade-in-up text-[14px] leading-[2.15] tracking-[0.08em] text-[#31353A]/76"
                    style={{
                      fontFamily: "Noto Sans TC, sans-serif",
                      fontWeight: 300,
                    }}
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button
                      type="submit"
                      disabled={
                        followUpQuestion.trim().length < 2 ||
                        followUpMutation.isPending
                      }
                  ...
                  <div className="mt-5 flex flex-col gap-3">
                    {followUpExchanges.map((item, index) => (
                      ...
                      >
                        ...
                        <div
                          className="text-[13px] leading-[2.05] tracking-[0.08em] text-[#31353A]/78"
                          style={{
                            fontFamily: "Noto Sans TC, sans-serif",
                            fontWeight: 300,
                          }}
            ...
            {!interpretMutation.isPending &&
              ...
              recommendations.length > 0 && (
                <section className="mt-6 rounded-2xl border border-[#D1BE9B]/22 bg-[#FAF7F4]/72 p-5 shadow-[0_18px_50px_rgba(163,141,107,0.1)] backdrop-blur-xl md:p-7">
                  ...
                  <p
                    className="mb-4 text-[12px] leading-[2] tracking-[0.1em] text-[#31353A]/54"
                    style={{
                      fontFamily: "Noto Sans TC, sans-serif",
                      fontWeight: 300,
                    }}
