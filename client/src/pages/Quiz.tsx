...
const RESULT_HEALING_IMAGES: Record<string, ResultHealingImage> = {
  "scent:A": {
    src: "/quiz-results/scent-white-peach-oolong.webp",
    alt: "白桃烏龍香氣的清甜療癒插畫",
    caption: "白桃烏龍｜清甜、乾淨、讓人放鬆",
  },
  "scent:B": {
    src: "/quiz-results/scent-white-musk.webp",
    alt: "白麝香香氣的乾淨棉被療癒插畫",
    caption: "白麝香｜乾淨、可靠、像曬過太陽的棉被",
  },
  "scent:C": {
    src: "/quiz-results/scent-rain-forest.webp",
    alt: "雨後森林香氣的濕潤森林療癒插畫",
    caption: "雨後森林｜濕潤木頭、青苔和安靜空氣",
  },
  "scent:D": {
    src: "/quiz-results/scent-rose-garden.webp",
    alt: "玫瑰花園香氣的浪漫療癒插畫",
    caption: "玫瑰花園｜有品味、有氛圍，也很真誠",
  },
  "soul-home:A": {
    src: "/quiz-results/soul-home-lunar-sanctuary.webp",
    alt: "靜謐月球的深夜療癒插畫",
    caption: "靜謐月球｜留一點空白，聽見自己的聲音",
  },
  "soul-home:B": {
    src: "/quiz-results/soul-home-seaside-retreat.webp",
    alt: "溫柔海邊的夕陽海浪療癒插畫",
    caption: "溫柔海邊｜有陪伴，也有可以呼吸的自由",
  },
  "soul-home:C": {
    src: "/quiz-results/soul-home-ancient-forest.webp",
    alt: "巨木森林的穩定療癒插畫",
    caption: "巨木森林｜穩定、踏實，也需要被支持",
  },
  "soul-home:D": {
    src: "/quiz-results/soul-home-fairytale-town.webp",
    alt: "童話小鎮的溫暖生活療癒插畫",
    caption: "童話小鎮｜被日常小事重新充滿電",
  },
  "past-life:A": {
    src: "/quiz-results/past-life-royal-sage.webp",
    alt: "王室顧問的古老圖書館療癒插畫",
    caption: "王室顧問｜冷靜看局，也記得照顧感受",
  },
  "past-life:B": {
    src: "/quiz-results/past-life-herbalist.webp",
    alt: "神祕草藥師的花草療癒插畫",
    caption: "神祕草藥師｜懂得照顧傷口，也要保留力氣",
  },
  "past-life:C": {
    src: "/quiz-results/past-life-astrologer.webp",
    alt: "皇家占星師的星空觀測療癒插畫",
    caption: "皇家占星師｜看懂規律，也給答案一點時間",
  },
  "past-life:D": {
  ...
  "love-magnet:C": {
    src: "/quiz-results/love-poetic-dreamer.webp",
    alt: "浪漫靈性型的星光花束療癒插畫",
    caption: "浪漫靈性型｜不只心動，也想懂你",
  },
  "love-magnet:D": {
    src: "/quiz-results/love-grounded-achiever.webp",
    alt: "專注事業型的咖啡桌面療癒插畫",
    caption: "專注事業型｜一起努力，也一起好好相待",
  },
  "stress-style:A": {
    src: "/quiz-results/stress-quiet-recharge.webp",
    alt: "安靜充電的房間窗光療癒插畫",
    caption: "安靜充電｜把不被打擾的時間還給自己",
  },
  "stress-style:B": {
    src: "/quiz-results/stress-soft-listening.webp",
    alt: "被好好理解的茶與陪伴療癒插畫",
    caption: "被好好理解｜不用先整理好，才值得被聽見",
  },
  "stress-style:C": {
    src: "/quiz-results/stress-gentle-reset.webp",
    alt: "重新整理生活的清爽桌面療癒插畫",
    caption: "重新整理生活｜先整理一小塊，心也會跟著穩",
  },
  "stress-style:D": {
    src: "/quiz-results/stress-move-energy.webp",
    alt: "需要行動感的陽光散步療癒插畫",
    caption: "一點行動感｜讓悶住的能量先流動起來",
  },
  "decision-style:A": {
    src: "/quiz-results/decision-people-first.webp",
    alt: "怕讓人失望時寫下真心的療癒插畫",
    caption: "怕讓人失望｜先聽見自己真正想選什麼",
  },
  "decision-style:B": {
    src: "/quiz-results/decision-overthinking-loop.webp",
    alt: "想找到最好答案時的筆記咖啡療癒插畫",
    caption: "想找到最好答案｜先選一個能往前走的版本",
  },
  "decision-style:C": {
    src: "/quiz-results/decision-need-ground.webp",
    alt: "需要安全感時的溫暖居家療癒插畫",
    caption: "需要安全感｜有退路，才更敢往前",
  },
  "decision-style:D": {
    src: "/quiz-results/decision-waiting-mode.webp",
    alt: "等待準備好時踏出小步的療癒插畫",
    caption: "等自己準備好｜先做很小的一步就算開始",
  },
  "heart-weather:A": {
    src: "/quiz-results/weather-misty-morning.webp",
    alt: "微霧早晨的柔光療癒插畫",
    caption: "微霧早晨｜不用急，霧會慢慢散",
  },
  "heart-weather:B": {
    src: "/quiz-results/weather-soft-rain.webp",
    alt: "安靜小雨的窗邊療癒插畫",
    caption: "安靜小雨｜允許自己低落，也給自己一點暖",
  },
  "heart-weather:C": {
    src: "/quiz-results/weather-clearing-sky.webp",
    alt: "雲後放晴的花與天空療癒插畫",
    caption: "雲後放晴｜抓住那一點想變好的念頭",
  },
  "heart-weather:D": {
    src: "/quiz-results/weather-quiet-moonlight.webp",
    alt: "深夜月光的安靜療癒插畫",
    caption: "深夜月光｜安靜下來，答案會慢慢浮上來",
  },
};
...
export default function QuizPage() {
  ...
  const [contactProduct, setContactProduct] = useState<string | undefined>(
    undefined
  );
  ...
  const calculateResult = (answers: string[]) => {
    ...
    const finalResult =
      activeQuiz.results[maxKey] || Object.values(activeQuiz.results)[0];
  ...
  const recommendedProduct = quizResult
    ? findProduct(quizResult.crystalSlug)
    : undefined;
  const resultHealingImage = getResultHealingImage(
    activeQuiz?.slug,
    quizResult?.key
  );
  ...
  return (
    <PageLayout>
      <div
        className={`quiz-archive-shell min-h-screen py-12 px-4 md:px-8 ${theme.bg} relative overflow-hidden transition-colors duration-1000`}
      >
        ...
        <div
          className={`quiz-ambient-blob quiz-ambient-blob-one absolute top-1/6 left-1/6 w-[450px] h-[450px] rounded-full ${theme.blob1} pointer-events-none z-0 transition-colors duration-1000`}
        />
        <div
          className={`quiz-ambient-blob quiz-ambient-blob-two absolute bottom-[24%] right-[24%] w-[440px] h-[440px] rounded-full ${theme.blob2} pointer-events-none z-0 transition-colors duration-1000`}
        />
          ...
          {!activeQuiz && (
            <div className="animate-fade-in-up">
              ...
              <div className="text-center mb-12">
                <span
                  className="inline-flex items-center gap-3 rounded-full border border-[#B89D68]/25 bg-[#F8F1E7]/55 px-5 py-2 text-[10px] tracking-[0.42em] text-[#9A7C52] uppercase shadow-[0_10px_30px_rgba(86,66,42,0.06)]"
                  style={{
                ...
                <h1
                  className="text-xl md:text-3xl tracking-[0.24em] font-extralight text-[#2F3336] mt-5 mb-4"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
                ...
                <p
                  className="max-w-xl mx-auto text-[12px] md:text-[13px] leading-[2.1] text-[#31353A]/62 tracking-[0.16em] mb-5"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
                ...
                {QUIZZES.map((quiz, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-start justify-between gap-4 mb-8">
                      <div>
                        <span
                          className="text-[10px] tracking-[0.35em] text-[#9A7C52]/70 uppercase"
                    ...
                    <div className="relative z-10">
                      <span
                        className="text-[9px] tracking-[0.26em] text-[#9A7C52] uppercase font-light"
                        style={{ fontFamily: "Noto Serif TC, serif" }}
                      >
                        {quiz.subtitle}
                      </span>
                      <h3
                        className="text-[17px] md:text-lg tracking-[0.13em] text-[#2F3336] mt-2 mb-3 font-medium"
                        style={{ fontFamily: "Noto Serif TC, serif" }}
                      >
                        {quiz.name}
                      </h3>
                      <p
                        className="text-[12px] leading-[1.95] text-[#31353A]/62 font-light"
                        style={{ fontFamily: "Noto Serif TC, serif" }}
                      >
                        {quiz.desc}
                      </p>
                    ...
                    <div className="relative z-10 flex justify-between items-center mt-7 pt-4 border-t border-[#B89D68]/15">
                      <span
                        className="text-[9px] tracking-[0.24em] text-[#31353A]/38 uppercase"
                        style={{ fontFamily: "Cormorant Garamond, serif" }}
                      >
                        Sealed Reading
                      </span>
                      <span
                        className="text-[10px] tracking-[0.18em] text-[#8A6D45] transition-colors flex items-center gap-1"
                        style={{ fontFamily: "Noto Serif TC, serif" }}
                      >
                        開啟檔案 ✦
                      </span>
              ...
              <div className="flex justify-center mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <p
                    className="text-[11px] text-[#31353A]/50 tracking-wider italic"
                    style={{
                      fontFamily: "Noto Serif TC, serif",
                      fontWeight: 200,
                    }}
          ...
          {activeQuiz && !quizResult && (
            <div className="animate-fade-in-up max-w-xl mx-auto text-center">
              ...
              <div className="mb-8">
                ...
                <h2
                  className="text-xl md:text-2xl tracking-[0.15em] text-[#31353A] mt-1.5 mb-3"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 300,
                  }}
                ...
                <div className="flex flex-col items-center gap-1.5 mt-4 select-none">
                  ...
                  <span className="text-[9px] text-[#A38D6B] font-light mt-1">
                    第 {currentQuestionIdx + 1} 題 ｜ 共{" "}
                    {activeQuiz.questions.length} 題
                  </span>
                </div>
              </div>
              ...
              >
                <div
                  className="mb-5 flex items-center justify-between gap-4 text-[9px] tracking-[0.26em] text-[#9A7C52]/70 uppercase"
                  style={{ fontFamily: "Cormorant Garamond, serif" }}
                >
                  <span>
                    Entry {String(currentQuestionIdx + 1).padStart(2, "0")}
                  </span>
                  <span>Listen first</span>
                </div>
                <p
                  className="text-[14px] md:text-[15.5px] leading-[2.1] text-[#31353A] tracking-wider mb-8 font-light"
                  style={{ fontFamily: "Noto Serif TC, serif" }}
                >
                ...
                <div className="flex flex-col gap-3.5">
                  {activeQuiz.questions[currentQuestionIdx].options.map(
                    (opt, idx) => (
                      ...
                      >
                        <span
                          className={`inline-block mr-2.5 text-[10px] font-serif transition-colors duration-150 ${
                            selectedOptionKey === opt.scoreKey
                              ? "text-[#D1BE9B]"
                              : "text-[#A38D6B]"
                          }`}
          ...
          {activeQuiz && quizResult && (
            <div className="animate-fade-in-up max-w-2xl mx-auto text-center">
              ...
              <div className="quiz-result-card bg-white/55 border border-[#D1BE9B]/25 rounded-[40px] p-8 md:p-12 shadow-[0_20px_60px_rgba(209,190,155,0.12)] relative overflow-hidden mb-8">
                ...
                <div className="absolute top-4 left-6 opacity-30 select-none text-xs">
                  𓆩♡𓆪
                </div>
                <div className="absolute top-4 right-6 opacity-30 select-none text-xs">
                  𓆩♡𓆪
                </div>
                ...
                <h3
                  className="text-base italic text-[#A38D6B] mt-2 mb-2 font-serif"
                  style={{ fontFamily: "Cormorant Garamond, serif" }}
                >
                  {activeQuiz.name}
                </h3>
                ...
                <div className="inline-block px-8 py-2.5 bg-[#3D4144] text-[#FAF7F4] rounded-full shadow-md mt-2 mb-6">
                  <span
                    className="text-sm md:text-base tracking-[0.3em] font-light flex items-center justify-center gap-1.5"
                    style={{ fontFamily: "Noto Serif TC, serif" }}
                  >
                ...
                {quizResult.subtitle && (
                  <p
                    className="text-[11px] tracking-[0.25em] text-[#A38D6B] uppercase italic mb-6 font-light"
                    style={{ fontFamily: "Cormorant Garamond, serif" }}
                  >
                    {quizResult.subtitle}
                  </p>
                ...
                {resultHealingImage && (
                  <div className="mx-auto mb-7 w-full max-w-sm overflow-hidden rounded-[28px] border border-[#D1BE9B]/20 bg-white/45 p-2 shadow-[0_14px_40px_rgba(209,190,155,0.14)]">
                    ...
                    />
                    <p
                      className="px-3 py-3 text-center text-[11px] leading-relaxed tracking-[0.12em] text-[#6F6256]/70 font-light"
                      style={{ fontFamily: "Noto Serif TC, serif" }}
                    >
                ...
                {/* Poetic description */}
                <p
                  className="text-[13px] md:text-[14px] leading-[2.1] text-[#31353A]/82 tracking-wider whitespace-pre-line text-left px-2 mb-8 font-light"
                  style={{ fontFamily: "Noto Serif TC, serif" }}
                >
                ...
                {recommendedProduct && (
                  <div className="mt-8 pt-8 border-t border-[#D1BE9B]/15 text-left animate-fade-in-up">
                    <p
                      className="text-[10px] tracking-[0.3em] text-[#D1BE9B] uppercase mb-4 text-center sm:text-left"
                      style={{
                        fontFamily: "Noto Serif TC, serif",
                        fontWeight: 300,
                      }}
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 items-center bg-white/40 border border-[#D1BE9B]/20 p-5 rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        <span
                          className="text-[10px] tracking-[0.2em] text-[#D1BE9B] font-light"
                          style={{ fontFamily: "Noto Serif TC, serif" }}
                        >
                          {recommendedProduct.material}
                        </span>
                        <h4
                          className="text-sm md:text-base tracking-[0.12em] text-[#31353A] font-medium mt-0.5"
                          style={{ fontFamily: "Noto Serif TC, serif" }}
                        >
                          {recommendedProduct.name}
                        </h4>
                        <p
                          className="text-[11px] leading-relaxed tracking-[0.08em] text-[#31353A]/60 mb-3 line-clamp-2"
                          style={{
