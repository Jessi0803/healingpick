...
const RESULT_HEALING_IMAGES: Record<string, ResultHealingImage> = {
  'scent:A': { src: '/quiz-results/scent-white-peach-oolong.png', alt: '白桃烏龍香氣的清甜療癒插畫', caption: '白桃烏龍｜清甜、乾淨、讓人放鬆' },
  'scent:B': { src: '/quiz-results/scent-white-musk.png', alt: '白麝香香氣的乾淨棉被療癒插畫', caption: '白麝香｜乾淨、可靠、像曬過太陽的棉被' },
  'scent:C': { src: '/quiz-results/scent-rain-forest.png', alt: '雨後森林香氣的濕潤森林療癒插畫', caption: '雨後森林｜濕潤木頭、青苔和安靜空氣' },
  'scent:D': { src: '/quiz-results/scent-rose-garden.png', alt: '玫瑰花園香氣的浪漫療癒插畫', caption: '玫瑰花園｜有品味、有氛圍，也很真誠' },
  'soul-home:A': { src: '/quiz-results/soul-home-lunar-sanctuary.png', alt: '靜謐月球的深夜療癒插畫', caption: '靜謐月球｜留一點空白，聽見自己的聲音' },
  'soul-home:B': { src: '/quiz-results/soul-home-seaside-retreat.png', alt: '溫柔海邊的夕陽海浪療癒插畫', caption: '溫柔海邊｜有陪伴，也有可以呼吸的自由' },
  'soul-home:C': { src: '/quiz-results/soul-home-ancient-forest.png', alt: '巨木森林的穩定療癒插畫', caption: '巨木森林｜穩定、踏實，也需要被支持' },
  'soul-home:D': { src: '/quiz-results/soul-home-fairytale-town.png', alt: '童話小鎮的溫暖生活療癒插畫', caption: '童話小鎮｜被日常小事重新充滿電' },
  'past-life:A': { src: '/quiz-results/past-life-royal-sage.png', alt: '王室顧問的古老圖書館療癒插畫', caption: '王室顧問｜冷靜看局，也記得照顧感受' },
  'past-life:B': { src: '/quiz-results/past-life-herbalist.png', alt: '神祕草藥師的花草療癒插畫', caption: '神祕草藥師｜懂得照顧傷口，也要保留力氣' },
  'past-life:C': { src: '/quiz-results/past-life-astrologer.png', alt: '皇家占星師的星空觀測療癒插畫', caption: '皇家占星師｜看懂規律，也給答案一點時間' },
  'past-life:D': { src: '/quiz-results/past-life-artist.png', alt: '自由藝術家的畫室療癒插畫', caption: '自由藝術家｜把敏感變成創作和魅力' },
  'past-life:E': { src: '/quiz-results/past-life-voyager.png', alt: '流浪冒險家的地圖旅行療癒插畫', caption: '流浪冒險家｜想去遠方，也要帶著穩定感' },
  'love-magnet:A': { src: '/quiz-results/love-safe-harbor.png', alt: '成熟治癒型的安心港灣療癒插畫', caption: '成熟治癒型｜慢慢靠近，穩穩接住' },
  'love-magnet:B': { src: '/quiz-results/love-direct-light.png', alt: '熱烈直球型的陽光療癒插畫', caption: '熱烈直球型｜喜歡就靠近，明亮又直接' },
  'love-magnet:C': { src: '/quiz-results/love-poetic-dreamer.png', alt: '浪漫靈性型的星光花束療癒插畫', caption: '浪漫靈性型｜不只心動，也想懂你' },
  'love-magnet:D': { src: '/quiz-results/love-grounded-achiever.png', alt: '專注事業型的咖啡桌面療癒插畫', caption: '專注事業型｜一起努力，也一起好好相待' },
  'stress-style:A': { src: '/quiz-results/stress-quiet-recharge.png', alt: '安靜充電的房間窗光療癒插畫', caption: '安靜充電｜把不被打擾的時間還給自己' },
  'stress-style:B': { src: '/quiz-results/stress-soft-listening.png', alt: '被好好理解的茶與陪伴療癒插畫', caption: '被好好理解｜不用先整理好，才值得被聽見' },
  'stress-style:C': { src: '/quiz-results/stress-gentle-reset.png', alt: '重新整理生活的清爽桌面療癒插畫', caption: '重新整理生活｜先整理一小塊，心也會跟著穩' },
  'stress-style:D': { src: '/quiz-results/stress-move-energy.png', alt: '需要行動感的陽光散步療癒插畫', caption: '一點行動感｜讓悶住的能量先流動起來' },
  'decision-style:A': { src: '/quiz-results/decision-people-first.png', alt: '怕讓人失望時寫下真心的療癒插畫', caption: '怕讓人失望｜先聽見自己真正想選什麼' },
  'decision-style:B': { src: '/quiz-results/decision-overthinking-loop.png', alt: '想找到最好答案時的筆記咖啡療癒插畫', caption: '想找到最好答案｜先選一個能往前走的版本' },
  'decision-style:C': { src: '/quiz-results/decision-need-ground.png', alt: '需要安全感時的溫暖居家療癒插畫', caption: '需要安全感｜有退路，才更敢往前' },
  'decision-style:D': { src: '/quiz-results/decision-waiting-mode.png', alt: '等待準備好時踏出小步的療癒插畫', caption: '等自己準備好｜先做很小的一步就算開始' },
  'heart-weather:A': { src: '/quiz-results/weather-misty-morning.png', alt: '微霧早晨的柔光療癒插畫', caption: '微霧早晨｜不用急，霧會慢慢散' },
  'heart-weather:B': { src: '/quiz-results/weather-soft-rain.png', alt: '安靜小雨的窗邊療癒插畫', caption: '安靜小雨｜允許自己低落，也給自己一點暖' },
  'heart-weather:C': { src: '/quiz-results/weather-clearing-sky.png', alt: '雲後放晴的花與天空療癒插畫', caption: '雲後放晴｜抓住那一點想變好的念頭' },
  'heart-weather:D': { src: '/quiz-results/weather-quiet-moonlight.png', alt: '深夜月光的安靜療癒插畫', caption: '深夜月光｜安靜下來，答案會慢慢浮上來' },
};
