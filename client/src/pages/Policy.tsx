...
const sections = [
  ...
  },
  {
    title: '療癒選物購買與退換貨政策',
    items: [
      '網站上的療癒水晶與療癒選物目前採私訊諮詢與確認訂單方式購買，可透過 LINE、Instagram 或 Email 先行詢問適合度、庫存、價格與付款方式。',
      '商品價格、付款方式、寄送方式、預計出貨時間與訂單內容，會於私訊確認訂單時說明；訂單成立後，將依雙方確認之內容安排付款與出貨。',
      '消費者收到商品後，如商品本身有瑕疵、寄送錯誤或運送過程造成損壞，請於收到商品後 7 日內聯繫客服，並提供商品照片、包裝照片與訂單資訊，我們將協助處理換貨或退費。',
      '若消費者依消費者保護法主張通訊交易解除權，請於收到商品後 7 日內聯繫客服辦理，商品須保持完整、未使用，並連同原包裝、配件一併退回。',
      '若商品已拆封、使用、配戴、沾染氣味、污損，或因個人因素造成損壞，恕無法辦理退換貨。',
      '客製化、依消費者需求特別製作或調整之商品，除商品瑕疵或寄送錯誤外，恕不接受取消、退換貨或退費。',
    ],
  },
  {
    title: '服務性質說明',
