...
function ScoreBar({ label, score, color }: { label: string; score: number; color: string }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-[10px] tracking-[0.15em] text-[#3D4144]/60 w-12 flex-shrink-0"
        style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
        {label}
      </span>
      ...
      <span className="text-[10px] tracking-wider text-[#3D4144]/50 w-6 text-right"
      ...
      <div className="min-h-screen py-12 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <p className="text-xs text-[#3D4144]/40 tracking-[0.2em]"
              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
              {dateStr}
            </p>
          </div>
          ...
          <div>
              ...
              <div className="glass-panel rounded-2xl p-6 border border-[#D1BE9B]/20 mb-8 flex flex-col md:flex-row items-center gap-6 animate-fade-in-up">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg tracking-[0.15em] text-[#3D4144]/80 mb-1"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                    {aiData?.crystal || '選擇星座以獲取推薦'}
                  </p>
                  <p className="text-[11px] leading-[1.9] text-[#3D4144]/50 tracking-wider"
                    style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 mb-8">
                {ZODIAC_SIGNS.map(sign => (
                  <button
                    ...
                    <span className="text-[9px] tracking-[0.1em] text-[#3D4144]/70"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                      {sign.name}
                    </span>
                    <span className="text-[7px] text-[#3D4144]/35 tracking-wider"
                      style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}>
                      {sign.dates}
                    </span>
                  </button>
                ...
                <div className="animate-fade-in-up">
                  <div className="glass-panel rounded-2xl p-8 border border-[#D1BE9B]/20">
                    ...
                    <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[#D1BE9B]/15">
                      ...
                      <div>
                        <h3 className="text-lg tracking-[0.15em] text-[#3D4144]/80"
                          style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                      ...
                      <div className="ml-auto flex flex-col items-end gap-2">
                        ...
                        {dailyFortuneQuery.isLoading && (
                          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#D1BE9B]/10 border border-[#D1BE9B]/20">
                            ...
                            <span className="text-[9px] tracking-[0.15em] text-[#3D4144]/40"
                              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                              計算月相中...
                            </span>
                          </div>
                    ...
                    {dailyFortuneQuery.isLoading && (
                      <div className="flex flex-col items-center gap-4 py-12">
                        ...
                        <p className="text-[11px] tracking-[0.2em] text-[#3D4144]/40"
                          style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                          Mochi 正在觀察今日月相與星象能量...
                        </p>
                      </div>
                    ...
                    {dailyFortuneQuery.isError && (
                      <div className="text-center py-8">
                        <p className="text-[11px] text-[#3D4144]/40 tracking-wider mb-3"
                          style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                          運勢解讀暫時無法取得，請稍後再試
                        </p>
                        <button
                    ...
                    {aiData && (
                      <>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                          {[
                            ...
                            <div key={item.label} className="text-center p-3 rounded-xl bg-[#D1BE9B]/8">
                              ...
                              <p className="text-xs tracking-[0.1em] text-[#3D4144]/70"
                                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                                {item.value}
                              </p>
                            </div>
                          ...
                          {[
                            ...
                            <div key={item.label} className="flex gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-[11px] leading-[2] text-[#3D4144]/60 tracking-wider"
                                  style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}>
                                  {item.text}
                                </p>
                              </div>
                        ...
                        <div className="pt-4 border-t border-[#D1BE9B]/15">
                          <div className="flex gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-[11px] leading-[2] text-[#3D4144]/60 tracking-wider italic"
                                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                                {aiData.advice}
                              </p>
                            </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-[#D1BE9B]/15 flex items-center justify-between">
                          <p className="text-[11px] text-[#3D4144]/50 tracking-wider"
                            style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
