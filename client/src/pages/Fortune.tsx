...
function getFortuneRecommendationMessage(
  ...
  if (fortune) {
    ...
    if (focus) {
      ...
      const action =
        focus.score >= 8 ? "順著好的狀態往前推進" : `先把${theme}調穩`;
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <div className="min-w-0">
              ...
              <p
                className="text-[12px] tracking-[0.12em] text-[#31353A]/86 mt-0.5 truncate"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {product.name}
              </p>
          ...
          <div className="mb-2 rounded-xl border border-[#D1BE9B]/15 bg-[#F8F4EC]/45 px-3 py-2">
            <p
              className="text-[10px] tracking-[0.18em] text-[#A38D6B] mb-1"
              style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
            >
              為什麼 Mochi 想到它
            </p>
            <div
              className="text-[11px] leading-relaxed tracking-[0.08em] text-[#31353A]/62 prose prose-sm max-w-none prose-strong:text-[#31353A]/86 prose-strong:font-semibold [&_p]:!my-0 [&_p]:!text-[11px] [&_p]:!leading-relaxed"
              style={{
                fontFamily: "Noto Sans TC, sans-serif",
                fontWeight: 300,
              }}
...
function HowItWorksPanel() {
  ...
  return (
    <div className="mb-8 px-5 py-4 rounded-2xl border border-[#D1BE9B]/15 bg-[#D1BE9B]/5">
      <p
        className="text-[11px] tracking-[0.3em] text-[#8A7250] mb-3 text-center"
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 sm:items-start">
        {insights.map((item, i) => (
          <div
            key={item.label}
            className="flex sm:flex-col sm:flex-1 items-start sm:items-center gap-3 sm:gap-2 sm:text-center"
          >
            {i > 0 && (
            ...
            <div className="flex sm:flex-col sm:items-center gap-3 sm:gap-2 flex-1">
              ...
              <div>
                <p
                  className="text-[11px] tracking-[0.2em] text-[#8A7250] mb-0.5"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 500,
                  }}
                ...
                {item.desc && (
                  <p
                    className="text-[12px] leading-[1.7] text-[#31353A]/62 tracking-wide"
                    style={{
                      fontFamily: "Noto Sans TC, sans-serif",
                      fontWeight: 300,
                    }}
      ...
      <Dialog>
        ...
        >
          ...
          >
            <p>
              你可以把每日運勢想成一份
              <strong className="font-medium text-[#A38D6B]">
                「今天的能量天氣預報」
              </strong>
              。<br />
              <br />
            ...
            <div>
              ...
              <p>
                Mochi
                會先用今天的日期計算月亮走到哪個階段。新月、滿月、上弦月、下弦月的感覺都不一樣：有些日子適合開始，有些日子適合整理，有些日子則比較適合放下。
                <br />
                <br />
            ...
            <div>
              ...
              <p>
                同一個滿月，牡羊座和雙魚座感受到的重點不會完全一樣。牡羊可能會被提醒「別急著衝」，雙魚可能會被提醒「先照顧情緒」。
                <br />
                <br />
                因為每個星座都有自己的元素、性格節奏、優勢和容易卡住的地方，Mochi
                會把這些放進解讀裡，讓提醒比較像是寫給你，而不是寫給所有人。
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                最後，Mochi
                會把「今日月相」和「你的星座特性」整理成幾個生活面向：整體狀態、感情、工作財運、健康與策略提醒。
                <br />
                <br />
...
function ScoreBar({
  ...
  return (
    <div className="flex items-center gap-3">
      <span
        className="text-[11px] tracking-[0.15em] text-[#31353A]/72 w-12 flex-shrink-0"
        style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
      >
        {label}
      </span>
      ...
      <span
        className="text-[11px] tracking-wider text-[#31353A]/62 w-6 text-right"
      ...
      <div className="min-h-screen py-12 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <p
              className="text-xs text-[#31353A]/54 tracking-[0.2em]"
              style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 200 }}
            >
              {dateStr}
            </p>
          ...
          <div>
            ...
            <div className="glass-panel rounded-2xl p-6 border border-[#D1BE9B]/20 mb-8 flex flex-col md:flex-row items-center gap-6 animate-fade-in-up">
              ...
              <div className="flex-1">
                <p
                  className="text-[11px] tracking-[0.3em] text-[#D1BE9B] mb-1"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
                ...
                <p
                  className="text-lg tracking-[0.15em] text-[#31353A]/86 mb-1"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 300,
                  }}
                ...
                <p
                  className="text-[12px] leading-[1.9] text-[#31353A]/62 tracking-wider"
                  style={{
                    fontFamily: "Noto Sans TC, sans-serif",
                    fontWeight: 300,
                  }}
                >
                  {aiData?.crystalReason ||
                    "選擇你的星座，Mochi 將根據今日月相為你推薦最適合的能量水晶。"}
                </p>
              </div>
              {aiData && (
                <Link href="/shop" className="flex-shrink-0">
                  <button
                    className="text-xs tracking-[0.15em] px-4 py-2 border border-[#D1BE9B]/30 rounded-full text-[#D1BE9B] hover:bg-[#D1BE9B]/10 transition-colors"
                    style={{
                      fontFamily: "Noto Serif TC, serif",
                      fontWeight: 300,
                    }}
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 mb-8">
              {ZODIAC_SIGNS.map(sign => (
                ...
                >
                  <span className="text-xl" style={{ color: sign.color }}>
                    {sign.symbol}
                  </span>
                  <span
                    className="text-[11px] tracking-[0.1em] text-[#31353A]/80"
                    style={{
                      fontFamily: "Noto Serif TC, serif",
                      fontWeight: 300,
                    }}
                  ...
                  <span
                    className="text-[9px] text-[#31353A]/50 tracking-wider"
                    style={{
                      fontFamily: "Noto Sans TC, sans-serif",
                      fontWeight: 300,
                    }}
            ...
            {selectedSignData && (
              ...
              >
                <DialogContent
                  className="sm:max-w-md bg-[#FDFBF7] border-[#D1BE9B]/30 rounded-2xl p-6"
                  style={{ fontFamily: "Noto Serif TC, serif" }}
                >
                  <DialogHeader>
                  ...
                  <div className="text-center pt-2">
                    <div
                      className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-[#D1BE9B]/35"
                    ...
                    <p
                      className="mb-1 text-[13px] tracking-[0.18em] text-[#31353A]/84"
                      style={{ fontWeight: 400 }}
                    >
                      {selectedSignData.name}
                    </p>
                    <p
                      className="mb-5 text-[12px] leading-[1.9] tracking-[0.08em] text-[#31353A]/60"
                      style={{
                        fontFamily: "Noto Sans TC, sans-serif",
                        fontWeight: 300,
                      }}
                    >
                      Mochi
                      將結合今日月相能量，為你生成今天的整體、感情、事業與健康提醒。
                    </p>
                    ...
                    {credits?.enabled && (
                      <p
                        className="mt-3 text-[11px] leading-[1.8] tracking-[0.12em] text-[#31353A]/45"
                        style={{
                          fontFamily: "Noto Serif TC, serif",
                          fontWeight: 200,
                        }}
              ...
              <div className="animate-fade-in-up">
                <div className="glass-panel rounded-2xl p-8 border border-[#D1BE9B]/20">
                  ...
                  <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[#D1BE9B]/15">
                    ...
                    <div>
                      <h3
                        className="text-lg tracking-[0.15em] text-[#31353A]/86"
                        style={{
                          fontFamily: "Noto Serif TC, serif",
                          fontWeight: 300,
                        }}
                      ...
                      <p
                        className="text-[11px] italic text-[#D1BE9B]"
                        style={{ fontFamily: "Cormorant Garamond, serif" }}
                      >
                    ...
                    <div className="ml-auto flex flex-col items-end gap-2">
                      ...
                      {aiData?.moonPhase && aiData?.moonSymbol && (
                        <MoonPhaseBadge
                          symbol={aiData.moonSymbol}
                          name={aiData.moonPhase}
                        />
                      )}
                      {dailyFortuneQuery.isLoading && (
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#D1BE9B]/10 border border-[#D1BE9B]/20">
                          <span className="text-[#D1BE9B] animate-spin text-xs">
                            ✦
                          </span>
                          <span
                  ...
                  <>
                    ...
                    {dailyFortuneQuery.isLoading && (
                      ...
                      >
                        <p
                          className="text-[12px] tracking-[0.2em] text-[#31353A]/54"
                          style={{
                            fontFamily: "Noto Serif TC, serif",
                            fontWeight: 300,
                          }}
                    ...
                    {dailyFortuneQuery.isError && (
                      <div className="text-center py-8">
                        <p
                          className="text-[12px] text-[#31353A]/54 tracking-wider mb-3"
                          style={{
                            fontFamily: "Noto Serif TC, serif",
                            fontWeight: 300,
                          }}
                    ...
                    {aiData && (
                      <div ref={fortuneResultRef}>
                        {caughtMoodPlushie && (
                          <div
                            className="mb-5 rounded-2xl border border-[#D1BE9B]/20 bg-[#FFFDF9]/75 px-4 py-3 text-[13px] leading-[2] tracking-[0.08em] text-[#6F5A3A]/82"
                            style={{
                              fontFamily: "Noto Sans TC, sans-serif",
                              fontWeight: 300,
                            }}
                        ...
                        {/* Scores */}
                        <div
                          className="space-y-3 mb-6 animate-fade-in-up"
                        ...
                        >
                          ...
                          <ScoreBar
                            label="感情"
                            score={aiData.loveScore}
                            color="#EAA8AC"
                          />
                          <ScoreBar
                            label="事業"
                            score={aiData.careerScore}
                            color="#A0B898"
                          />
                          <ScoreBar
                            label="健康"
                        ...
                        {/* Lucky info */}
                        <div
                          className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6 animate-fade-in-up"
                        ...
                        >
                          {[
                            ...
                            {
                              label: "幸運數字",
                              value: aiData.luckyNumber.toString(),
                            },
                            { label: "能量水晶", value: aiData.crystal },
                          ].map(item => (
                            <div
                              key={item.label}
                              className="text-center p-3 rounded-xl bg-[#D1BE9B]/8"
                            >
                              <p
                                className="text-[10px] tracking-[0.2em] text-[#D1BE9B] mb-1"
                                style={{
                                  fontFamily: "Noto Serif TC, serif",
                                  fontWeight: 200,
                                }}
                              ...
                              <p
                                className="text-xs tracking-[0.1em] text-[#31353A]/80"
                                style={{
                                  fontFamily: "Noto Serif TC, serif",
                                  fontWeight: 300,
                                }}
                        ...
                        <div className="space-y-4 mb-6">
                          {[
                            ...
                            >
                              <span className="text-[#D1BE9B] flex-shrink-0 mt-0.5 text-sm">
                                {item.icon}
                              </span>
                              <div>
                                <p
                                  className="text-[12px] tracking-[0.2em] text-[#6F5A3A] mb-1"
                                  style={{
                                    fontFamily: "Noto Serif TC, serif",
                                    fontWeight: 500,
                                  }}
                                ...
                                <div
                                  className="text-[13.5px] leading-[2] text-[#31353A]/72 tracking-wider prose prose-sm max-w-none prose-strong:text-[#31353A]/90 prose-strong:font-semibold [&_p]:!text-[13.5px] [&_p]:!leading-[2]"
                                  style={{
                                    fontFamily: "Noto Sans TC, sans-serif",
                                    fontWeight: 300,
                                  }}
                        ...
                        {selectedSignData && (
                          <div
                            className="mt-6 pt-6 border-t border-[#D1BE9B]/15 animate-fade-in-up"
                          ...
                          >
                            ...
                            <div className="mb-4 rounded-2xl border border-[#D1BE9B]/15 bg-white/35 px-4 py-3">
                              <div
                                className="text-[12px] leading-[1.9] tracking-[0.08em] text-[#31353A]/70 prose prose-sm max-w-none prose-strong:text-[#31353A]/90 prose-strong:font-semibold [&_p]:!my-0 [&_p]:!text-[12px] [&_p]:!leading-[1.9]"
                                style={{
                                  fontFamily: "Noto Sans TC, sans-serif",
                                  fontWeight: 300,
                                }}
                            ...
                            {(() => {
                              const recs = recommendForFortune(
                                selectedSignData.element
                              );
                              const ctx = getFortuneRecommendationMessage(
                                selectedSignData.element,
                                aiData
                              );
            ...
            {!selectedSign && (
              <div className="text-center py-8">
                <p
                  className="text-xs tracking-[0.2em] text-[#31353A]/50"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
