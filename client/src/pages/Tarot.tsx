          ...
          {step === 'reading' && (
            <div className="animate-fade-in-up">
              ...
              <div className="glass-panel rounded-2xl p-8 border border-[#D1BE9B]/20 mb-8">
                ...
                {llmInterpretation && (
                  <div>
                    <div className="prose prose-sm max-w-none text-[12.5px] leading-[2.1] text-[#31353A]/80 tracking-wider
                      prose-headings:font-normal prose-headings:tracking-[0.08em] prose-headings:text-[#A38D6B]
                      prose-h1:text-[14px] prose-h1:font-medium prose-h1:mt-8 prose-h1:mb-2 prose-h1:pb-1 prose-h1:border-b prose-h1:border-[#D1BE9B]/25
                      prose-h2:text-[15px] prose-h2:font-medium prose-h2:mt-8 prose-h2:mb-2 prose-h2:pb-1 prose-h2:border-b prose-h2:border-[#D1BE9B]/25
                      prose-h3:text-[14px] prose-h3:font-medium prose-h3:mt-8 prose-h3:mb-2 prose-h3:pb-1 prose-h3:border-b prose-h3:border-[#D1BE9B]/25
                      [&_h1]:!text-[14px] [&_h1]:!leading-[2.1] [&_h1]:!font-medium [&_h1]:!tracking-[0.08em] [&_h1]:!text-[#A38D6B] [&_h1]:!mt-8 [&_h1]:!mb-2 [&_h1]:!pb-1 [&_h1]:!border-b [&_h1]:!border-[#D1BE9B]/25
                      [&_h2]:!text-[15px] [&_h2]:!leading-[2.1] [&_h2]:!font-medium [&_h2]:!tracking-[0.08em] [&_h2]:!text-[#A38D6B] [&_h2]:!mt-8 [&_h2]:!mb-2 [&_h2]:!pb-1 [&_h2]:!border-b [&_h2]:!border-[#D1BE9B]/25
                      [&_h3]:!text-[14px] [&_h3]:!leading-[2.1] [&_h3]:!font-medium [&_h3]:!tracking-[0.08em] [&_h3]:!text-[#A38D6B] [&_h3]:!mt-8 [&_h3]:!mb-2 [&_h3]:!pb-1 [&_h3]:!border-b [&_h3]:!border-[#D1BE9B]/25
