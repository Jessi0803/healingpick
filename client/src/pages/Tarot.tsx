...
const HUMAN_TAROT_MENU_PLANS = [
  ...
  },
  {
    title: "塔羅超值套裝",
    price: "NT$999",
    summary: "適合想一次整理完整主題的人，把感情、財富、職涯或人生狀態拆成一組問題慢慢看清楚。",
    details: [
...
const MAJOR_ARCANA: TarotCard[] = [
  {
    ...
    en: "The Fool",
    symbol: "☽",
    meaning: "新的開始、純真、冒險、自由精神",
    reversed: "魯莽、缺乏計畫、天真過頭",
  },
  {
    id: 1,
    name: "魔術師",
    en: "The Magician",
    symbol: "✦",
    meaning: "意志力、技巧、資源豐富、顯化能力",
    reversed: "操縱、技巧不足、資源浪費",
  },
  {
    id: 2,
    name: "女祭司",
    ...
    symbol: "◈",
    meaning: "直覺、神秘、內在智慧、潛意識",
    reversed: "壓抑直覺、秘密、表面化",
  },
  {
    id: 3,
    name: "女皇",
    en: "The Empress",
    symbol: "♡",
    meaning: "豐盛、母性、創造力、自然之美",
    reversed: "依賴、創意阻塞、過度保護",
  },
  {
    id: 4,
    name: "皇帝",
    en: "The Emperor",
    symbol: "♔",
    meaning: "權威、穩定、結構、父性保護",
    reversed: "獨裁、缺乏彈性、控制欲強",
  },
  {
    id: 5,
    name: "教皇",
    en: "The Hierophant",
    symbol: "✙",
    meaning: "傳統、信仰、精神指引、社會規範",
    reversed: "反傳統、個人信念、打破規則",
  },
  {
    id: 6,
    name: "戀人",
    en: "The Lovers",
    symbol: "♥",
    meaning: "愛情、選擇、和諧、價值觀一致",
    reversed: "不和諧、錯誤選擇、價值觀衝突",
  },
  {
    id: 7,
    name: "戰車",
    en: "The Chariot",
    symbol: "⚔",
    meaning: "意志力、勝利、自律、克服障礙",
    reversed: "失控、侵略性、缺乏方向",
  },
  {
    id: 8,
    name: "力量",
    en: "Strength",
    symbol: "∞",
    meaning: "內在力量、勇氣、耐心、溫柔的控制",
    reversed: "懷疑自我、缺乏信心、情緒失控",
  },
  {
    id: 9,
    name: "隱士",
    en: "The Hermit",
    symbol: "☆",
    meaning: "內省、孤獨、智慧、靈性探索",
    reversed: "孤立、拒絕幫助、過度內省",
  },
  {
    id: 10,
    name: "命運之輪",
    en: "Wheel of Fortune",
    symbol: "⊕",
    meaning: "命運、轉折點、循環、好運",
    reversed: "壞運、抗拒改變、命運失控",
  },
  {
    id: 11,
    name: "正義",
  ...
  },
  {
    ...
    en: "The Tower",
    symbol: "⚡",
    meaning: "突然改變、混亂、啟示、重建",
    reversed: "避免災難、延遲崩潰、內部動盪",
  },
  {
    id: 17,
    name: "星星",
  ...
  },
  {
    ...
    en: "The Moon",
    symbol: "☾",
    meaning: "幻象、恐懼、潛意識、不確定",
    reversed: "困惑消散、恐懼面對、清晰浮現",
  },
  {
    id: 19,
    name: "太陽",
  ...
  },
  {
    ...
    en: "The World",
    symbol: "○",
    meaning: "完成、整合、成就、旅程終點",
    reversed: "未完成、缺乏閉合、停滯",
  },
];
...
const MINOR_SUITS = [
  {
    ...
    cards: [
      ...
      [
        ...
        "Four",
        "穩定喜悅、慶祝成果、關係安定、階段完成",
        "安全感不足、表面和諧、聚會延遲、根基不穩",
      ],
      [
        "五",
        "Five",
        "競爭摩擦、意見衝突、各自用力、需要協調",
        "避免衝突、內耗減少、勝負心退、重新找共識",
      ],
      [
        "六",
        "Six",
        "被看見、勝利回應、公開肯定、局勢好轉",
        "認可不足、過度在意評價、短暫勝利、自信動搖",
      ],
      [
        "七",
        "Seven",
      ...
      [
        ...
        "Ten",
        "責任沉重、壓力過載、獨自承擔、接近終點",
        "卸下負擔、分工求助、過勞警訊、責任重新分配",
      ],
      [
        "侍者",
        "Page",
        "新訊息、好奇探索、嘗試行動、熱情邀請",
        "三分鐘熱度、消息不穩、幼稚衝動、缺乏後續",
      ],
      [
        "騎士",
        "Knight",
        "積極追求、快速行動、熱烈表達、冒險精神",
        "衝動躁進、忽冷忽熱、承諾不足、來得快去得快",
      ],
      [
        "皇后",
        "Queen",
        "自信魅力、溫暖支持、創造力旺盛、吸引力強",
        "情緒化控制、嫉妒心、過度付出、自我價值不穩",
      ],
      [
        "國王",
        "King",
        "成熟領導、明確目標、掌控局面、穩定推進",
        "強勢固執、控制欲、急於主導、行動缺乏彈性",
      ],
    ],
  },
  {
    ...
    cards: [
      [
        ...
        "Ace",
        "情感開始、心意流動、溫柔靠近、療癒感受",
        "情緒封閉、愛意受阻、心意未表達、感受混亂",
      ],
      [
        "二",
        "Two",
        "互相吸引、真誠連結、關係靠近、情感交換",
        "失衡關係、誤會疏離、單方面付出、連結變弱",
      ],
      [
        "三",
        "Three",
        "朋友支持、愉快聚會、情緒分享、共同慶祝",
        "小圈摩擦、第三方干擾、過度玩樂、情感不專注",
      ],
      [
        "四",
        "Four",
        "情緒倦怠、提不起勁、錯過機會、需要整理心",
        "重新打開、願意接受、厭倦感退、看見新可能",
      ],
      [
        "五",
        "Five",
        "失落遺憾、看著失去、情緒低潮、仍有未看見的支持",
        "走出難過、接受現實、慢慢整理、重新看見希望",
      ],
      [
        "六",
        "Six",
        "回憶牽動、舊人舊事、單純善意、過去影響現在",
        "走出懷舊、放下過去、童年課題、舊情難續",
      ],
      [
        "七",
        "Seven",
        "選項太多、幻想投射、難以決定、需要看清現實",
        "幻想落地、做出選擇、看清真相、減少混亂",
      ],
      [
        "八",
        "Eight",
        "離開消耗、尋找更深意義、情感抽離、轉身前進",
        "放不下、反覆回頭、害怕離開、停在不滿足裡",
      ],
      [
        "九",
        "Nine",
        "心願滿足、情緒享受、個人滿意、願望有機會",
        "滿足感空洞、貪心期待、表面快樂、願望延遲",
      ],
      [
        "十",
        "Ten",
        "情感圓滿、家庭和諧、關係穩定、幸福感累積",
        "理想落差、關係失和、期待過高、幸福感不穩",
      ],
      [
        "侍者",
        "Page",
        "曖昧訊息、溫柔示好、情感萌芽、直覺提醒",
        "情緒幼稚、訊息不明、害羞逃避、心意不成熟",
      ],
      [
        "騎士",
        "Knight",
        "浪漫邀約、情感表達、靠近示好、心意流動",
        "甜言蜜語、行動不足、情緒化追求、承諾模糊",
      ],
      [
        "皇后",
        "Queen",
        "溫柔共感、情緒包容、深度照顧、直覺敏銳",
        "過度敏感、情緒淹沒、界線不足、照顧到失衡",
      ],
      [
        "國王",
        "King",
  ...
  },
  {
    ...
    cards: [
      ...
      [
        "二",
        "Two",
        "僵持不決、封閉心門、兩難選擇、暫時不表態",
        "逃避結束、被迫面對、做出選擇、防衛鬆動",
      ],
      [
        "三",
        "Three",
        "心碎失望、刺痛真相、關係受傷、需要接受現實",
        "傷口整理、痛感放輕、釋放悲傷、慢慢站穩",
      ],
      [
        "四",
        "Four",
        "休息暫停、抽離恢復、沉澱思緒、暫不行動",
        "重新啟動、休息不足、不安回來、該醒來面對",
      ],
      [
        "五",
        "Five",
        "爭執勝負、口舌傷害、贏了也失去、關係消耗",
        "停止爭勝、和解可能、退一步、承認代價",
      ],
      [
        "六",
      ...
      [
        "八",
        "Eight",
        "自我限制、看不見出口、不安綁住、困在想法裡",
        "限制鬆開、找到出口、停止自困、重新掌握",
      ],
      [
        "九",
        "Nine",
        "睡前反覆、過度擔心、內疚壓力、腦中停不下來",
        "不安放輕、求助支持、放過自己、壓力下降",
      ],
      [
        "十",
  ...
  },
  {
    ...
    cards: [
      [
        "一",
        "Ace",
        "實際機會、金錢起點、穩定種子、可落地的開始",
        "機會延遲、資源不足、沒有落地、錯過好開端",
      ],
      [
        "二",
        "Two",
      ...
      [
        "三",
        "Three",
        "合作建設、專業被看見、共同完成、技術累積",
        "合作不順、品質不足、分工混亂、努力未被認可",
      ],
      [
        "四",
        "Four",
        "保守守成、抓住安全感、控制資源、害怕失去",
        "願意鬆手、資源流動、放下控制、花費失衡",
      ],
      [
        "五",
        "Five",
        "匱乏感、現實壓力、被排除感、需要求助",
        "找到支持、困境改善、走出匱乏、願意接受幫忙",
      ],
      [
        "六",
        "Six",
        "資源互助、公平給予、收到支援、金錢往來",
        "付出失衡、人情壓力、資源不公、依賴或控制",
      ],
      [
        "七",
        "Seven",
      ...
      [
        ...
        "Nine",
        "獨立富足、自我價值、享受成果、生活穩定",
        "依賴感、財務不安、表面富足、自我價值動搖",
      ],
      [
        "十",
        "Ten",
        "長期穩定、家庭資源、累積成果、關係承諾",
        "家族壓力、穩定破口、資源分配問題、承諾不穩",
      ],
      [
        "侍者",
        "Page",
        "學習新技能、實際消息、慢慢開始、腳踏實地",
        "進度慢、缺乏規劃、學習分心、機會未成熟",
      ],
      [
        "騎士",
      ...
      [
        ...
        "Queen",
        "照顧生活、豐盛穩定、務實溫柔、身心滋養",
        "過度操心、物質不安、照顧失衡、缺少安全感",
      ],
      [
        "國王",
        "King",
        "財務掌控、成熟承諾、事業穩定、可靠資源",
        "物質控制、固執保守、貪心壓力、承諾變沉重",
      ],
    ],
  },
] as const;
...
const CARD_IMAGES: Record<number, string> = Object.fromEntries(
  Array.from({ length: 78 }, (_, id) => [
    id,
    `/tarot/${String(id).padStart(2, "0")}.jpg`,
  ])
);
    ...
    >
      {imgUrl ? (
        ...
        <div className="relative w-full h-full overflow-hidden bg-[#F3EBDD] px-2 py-2 text-[#31353A]/76">
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-between text-center">
            <div>
              <p
                className="text-[9px] leading-tight tracking-[0.12em] text-[#6F5A3A]"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {card.name}
              </p>
              <p
                className="mt-0.5 text-[6.5px] leading-tight tracking-[0.1em] text-[#A38D6B]"
                style={{
            ...
            <div className="flex flex-1 flex-col items-center justify-center">
              <div
                className="mb-1 flex items-center justify-center rounded-full border border-[#D1BE9B]/35 bg-[#FFFDF8]/55 text-[22px] leading-none text-[#6F5A3A]/76 shadow-[0_6px_14px_rgba(209,190,155,0.18)]"
                style={{
                  width: "34%",
                  aspectRatio: "1 / 1",
              ...
              <div className="flex flex-wrap justify-center gap-0.5 px-1">
                {keywords.map(keyword => (
                  <span
                    key={keyword}
                    className="rounded-full border border-[#D1BE9B]/20 bg-[#FFFDF8]/50 px-1 py-[1px] text-[6.5px] leading-tight tracking-[0.05em] text-[#31353A]/58"
                    style={{
      ...
      {reversed && (
        <div className="absolute bottom-1 left-0 right-0 flex justify-center">
          <span
            className="text-[9px] tracking-wider text-[#EAA8AC] bg-black/30 px-1.5 py-0.5 rounded-full"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <div className="min-w-0">
              {product.tag && (
                <span
                  className="text-[10px] tracking-[0.15em] px-1.5 py-0.5 rounded-full bg-[#D1BE9B]/20 text-[#A38D6B] mr-1.5"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 300,
                  }}
              ...
              <span
                className="text-[10px] tracking-[0.15em] px-1.5 py-0.5 rounded-full bg-white/70 text-[#6F5A3A] border border-[#D1BE9B]/20"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {roleLabel}
              </span>
              <p
                className="text-[15px] tracking-[0.08em] text-[#31353A]/88 mt-1 truncate"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {product.name}
              </p>
          ...
          <div className="flex flex-wrap gap-1 mb-2">
            {meanings.map(m => (
              <span
                key={m}
                className="text-[10px] tracking-[0.1em] px-2 py-0.5 rounded-full bg-[#F0EBE3]/70 text-[#31353A]/62 border border-[#D1BE9B]/15"
                style={{
                  fontFamily: "Noto Sans TC, sans-serif",
                  fontWeight: 300,
                }}
          ...
          <span
            className="text-[11px] tracking-[0.15em] text-[#A38D6B]"
            style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
          >
            看看這款商品 →
          </span>
...
const QUESTION_CATEGORIES = [
  { id: "love", label: "感情", icon: "♥", questions: QUESTION_PROMPTS.love },
  {
    ...
    label: "工作",
    icon: "✦",
    questions: QUESTION_PROMPTS.career,
  },
  {
    id: "wealth",
    label: "財運",
    icon: "◇",
    questions: QUESTION_PROMPTS.wealth,
  },
  {
    id: "growth",
    label: "自我提升",
    icon: "☽",
    questions: QUESTION_PROMPTS.growth,
  },
  {
    id: "family",
    label: "家庭",
    icon: "⌂",
    questions: QUESTION_PROMPTS.family,
  },
  {
    id: "relationships",
    label: "人際",
    icon: "✧",
    questions: QUESTION_PROMPTS.relationships,
  },
  { id: "study", label: "學業", icon: "□", questions: QUESTION_PROMPTS.study },
  {
    ...
    label: "健康",
    icon: "△",
    questions: QUESTION_PROMPTS.health,
  },
...
export default function TarotPage() {
  ...
  const followUpMutation = trpc.tarot.followUp.useMutation({
    onSuccess: (data, variables) => {
      const requestKey = JSON.stringify([
        ...
        variables.cards
          .map(card => `${card.position}:${card.name}:${card.reversed}`)
          .join("|"),
      ]);
  ...
  const tarotWaitingMessage = useRotatingText(
    TAROT_WAITING_MESSAGES,
  ...
  useEffect(() => {
    ...
    const hasPendingStart =
      ...
      window.sessionStorage.getItem(TAROT_PENDING_START_KEY) === "1";
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!trimmedQuestion || !pending.interpretation || !pending.cards?.length)
        return;
  ...
  const handleTarotChoiceMove = (event: PointerEvent<HTMLElement>) => {
    ...
    card.style.setProperty(
      "--choice-rx",
      `${(-(py - 0.5) * maxTilt * 2).toFixed(2)}deg`
    );
  ...
  const handlePopularQuestionClick = (
    prompt: string,
    type: string,
    nextStep?: Step
  ) => {
  ...
  const renderPopularQuestions = (nextStep?: Step) => {
    const activeCategory =
      QUESTION_CATEGORIES.find(
        category => category.id === activeQuestionCategory
        ...
        <div className="tarot-human-page min-h-screen px-4 py-20 md:px-8">
          <style>{`
            ...
            .tarot-human-plan-card:hover {
              border-color: rgba(157, 123, 63, 0.32);
              background: rgba(255,253,248,0.82);
              transform: translateY(-1px);
            }
            .tarot-human-plan-card--primary {
              border-color: rgba(112, 138, 106, 0.22);
            }
            ...
            .tarot-human-reference-strip::-webkit-scrollbar {
              height: 8px;
            }
            .tarot-human-reference-strip::-webkit-scrollbar-thumb {
              border-radius: 999px;
              background: rgba(112, 138, 106, 0.24);
            }
            .tarot-human-reference-image {
              width: 100%;
              aspect-ratio: 960 / 1706;
              border-radius: 8px;
              object-fit: cover;
              scroll-snap-align: start;
              box-shadow: 0 14px 30px rgba(29, 28, 25, 0.16);
            }
            .tarot-human-reference-strip--single {
                ...
                {HUMAN_TAROT_MENU_PLANS.map((menu, index) => (
                  <Dialog key={menu.title}>
                    <DialogTrigger asChild>
                      <button
                        ...
                        className={`tarot-human-plan-card rounded-lg p-4 transition ${
                          index === 0 ? "tarot-human-plan-card--primary" : ""
                        }`}
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            <h2
                              className="text-[18px] leading-[1.5] tracking-[0.12em] text-[#34322d]"
                              style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 400 }}
                            >
                              {menu.title}
                            </h2>
                            <p
                              className="mt-3 text-[13px] leading-[1.8] tracking-[0.06em] text-[#31353A]/62"
                              style={{ fontFamily: "Noto Sans TC, sans-serif", fontWeight: 300 }}
                            >
                              {menu.summary}
                            </p>
                          ...
                          <strong
                            className="shrink-0 text-[20px] tracking-[0.08em] text-[#9d7b3f]"
                            style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 500 }}
                          >
                            {menu.price}
                          </strong>
                    ...
                    <DialogContent className="max-h-[86vh] max-w-[760px] overflow-y-auto rounded-lg border-[#D1BE9B]/30 bg-[#FFFDF8] text-[#34322d]">
                      ...
                      <div className="mt-6">
                        <div
                          className={`tarot-human-reference-strip ${
                            menu.images.length === 1 ? "tarot-human-reference-strip--single" : ""
                          }`}
                          aria-label={`${menu.title} Gooday 原圖參考`}
                        >
                          {menu.images.map((image) => (
                            <img
                              ...
                              src={image.src}
                              alt={image.alt}
                              className="tarot-human-reference-image"
                              loading="eager"
                            />
                          ))}
                        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {step === "intro" && (
            <div className="tarot-choice-stage animate-fade-in-up">
              ...
              `}</style>
              <canvas
                ref={tarotStardustCanvasRef}
                className="tarot-choice-stardust"
                aria-hidden="true"
              />
              <div className="tarot-choice-content">
                ...
                <div className="mb-10 text-center w-full">
                        ...
                        >
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p>
                                AI
                                最強的地方，就是很會把大量規則和細節快速整理出來。它可以在很短時間內，把牌面、位置、組合關係和你的問題放在一起看。
                                <br />
                                <br />
                            ...
                            <div>
                              ...
                              <p>
                                AI
                                算命不是隨便丟一段話給你，而是依照牌義、牌陣邏輯和你的問題去整理分析。
                              </p>
                            ...
                            <div className="bg-[#D1BE9B]/10 p-5 rounded-2xl border border-[#D1BE9B]/20 text-[#31353A]/80 mt-8 shadow-sm">
                              <div
                                ...
                                style={{ fontFamily: "Noto Serif TC, serif" }}
                              >
                                <CatListening className="w-7 h-7" /> Mochi
                                的悄悄話：
                              </div>
                              <p
                  ...
                  <p
                    className="text-sm italic text-[#31353A]/54 tracking-[0.15em]"
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className="tarot-choice-eyebrow tarot-choice-layer"
                      style={{ "--choice-z": "30px" } as CSSProperties}
                    >
                      FREE AI TAROT
                    </p>
                    <h2
                      className="tarot-choice-title tarot-choice-layer"
                      style={{ "--choice-z": "42px" } as CSSProperties}
                    >
                      AI 免費塔羅占卜
                    </h2>
                    <div
                      className="tarot-choice-mochi-visual tarot-choice-layer"
                    ...
                    >
                      ...
                      />
                      <p className="tarot-choice-mochi-caption">
                        讓 Mochi 來幫你把打結的毛球打開
                      </p>
                    </div>
                    <button
                    ...
                    <div
                      className="tarot-choice-ai-proof tarot-choice-layer"
                    ...
                    >
                      ...
                      <div className="tarot-choice-ai-proof-card" data-mark="◇">
                        <h3>先看感情、事業與目前走向</h3>
                        <p>
                          適合想知道對方想法、曖昧關係、復合機會、工作選擇、事業方向與下一步的人。
                        </p>
                      </div>
                      <div className="tarot-choice-ai-proof-card" data-mark="☽">
                        <h3>一次整理大量牌面資訊</h3>
                        <p>
                          AI
                          會同時分析牌義、正逆位、牌陣位置與牌面之間的連動，幫你看見容易忽略的訊號。
                        </p>
                      </div>
                    </div>
                  </article>
          ...
          {step === "shuffle" && (
            <div className="text-center animate-fade-in-up">
              <div className="mb-8">
                ...
                <p
                  className="mt-2 text-[15px] text-[#31353A]/58 tracking-wider"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                    fontSize: "15px",
                ...
                >
                  {isShufflingActive
                    ? "牌正在流動中，心裡默念你的問題；感覺到了就停下"
                    : "深呼吸三次，把問題放在心裡，準備好後開始洗牌"}
                </p>
              </div>
              ...
              >
                <div
                  className={`absolute w-52 h-52 rounded-full border border-[#D1BE9B]/18 transition-all duration-700 ${
                    isShufflingActive
                      ? "scale-110 opacity-100 shadow-[0_0_42px_rgba(209,190,155,0.20)]"
                      : "scale-95 opacity-50"
                  }`}
                />
              ...
              <div className="flex justify-center mt-6 mb-4">
                {isShufflingActive ? (
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span
                      className="text-[11px] tracking-[0.15em] text-[#D1BE9B]/50"
                      style={{
                        fontFamily: "Noto Serif TC, serif",
                        fontWeight: 200,
                      }}
          ...
          {step === "pick" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-8">
                ...
                <p
                  className="mt-3 text-[12px] text-[#31353A]/58 tracking-wider"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
                      ...
                      >
                        <span
                          className={`w-4 h-4 rounded-full flex items-center justify-center text-[10px] ${
                              ...
                              ? "bg-[#D1BE9B] text-white"
                              : current
                                ? "bg-[#D1BE9B]/50 text-white"
                                : "bg-[#D1BE9B]/15 text-[#31353A]/54"
                          }`}
                        >
                          {done ? "✓" : i + 1}
                        </span>
                ...
                {pickedIndices.length < 5 ? (
                  <div className="mt-4 inline-block px-5 py-2.5 rounded-2xl bg-[#D1BE9B]/8 border border-[#D1BE9B]/20">
                    <p
                      className="text-[12px] tracking-[0.15em] text-[#A38D6B]"
                      style={{
                        fontFamily: "Noto Serif TC, serif",
                        fontWeight: 300,
                      }}
                    >
                      🐾 第 {pickedIndices.length + 1} 張 ·{" "}
                      <span className="text-[#31353A]/86">
                        {SPREAD_POSITIONS[pickedIndices.length].label}
                      </span>
                    </p>
                    <p
                      className="mt-1 text-[11px] leading-[1.7] text-[#31353A]/58 tracking-wider"
                      style={{
                        fontFamily: "Noto Sans TC, sans-serif",
                        fontWeight: 300,
                      }}
                  ...
                  <p
                    className="mt-4 text-[12px] tracking-[0.2em] text-[#A38D6B] animate-pulse"
                    style={{
                      fontFamily: "Noto Serif TC, serif",
                      fontWeight: 300,
                    }}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {!isPicked && (
                          <div
                            className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#F8F0DC]/92 px-2.5 py-1 text-[10px] tracking-[0.16em] text-[#3D4144] opacity-0 shadow-[0_8px_18px_rgba(49,53,58,0.22)] transition-all duration-300 group-hover:opacity-100"
                            style={{
                              fontFamily: "Noto Serif TC, serif",
                              fontWeight: 400,
                            }}
                      ...
                      {isPicked && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 rounded-[11px] border border-[#F3E7CC]/70 bg-[#31353A]/72 shadow-[0_0_0_3px_rgba(209,190,155,0.12)] backdrop-blur-[1px] animate-fade-in-up">
                          ...
                          <span
                            className="text-[11px] tracking-[0.1em] text-white/95 px-1 text-center leading-tight"
                            style={{
                              fontFamily: "Noto Serif TC, serif",
                              fontWeight: 300,
                            }}
              ...
              {pickedIndices.length > 0 && pickedIndices.length < 5 && (
                <p
                  className="text-center mt-2 text-[11px] text-[#31353A]/50 tracking-wider animate-pulse"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
          ...
          {step === "spread" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-8">
                ...
                {question && (
                  <p
                    className="mt-2 text-xs italic text-[#31353A]/62 tracking-wider"
                    style={{ fontFamily: "Cormorant Garamond, serif" }}
                  >
                    「{question}」
                  </p>
                  ...
                  <div className="xl:hidden">
                    ...
                    >
                      {drawnCards.map((_, idx) => (
                        ...
                        >
                          <span
                            className="text-[11px] tracking-[0.15em] text-[#D1BE9B] whitespace-nowrap"
                            style={{
                              fontFamily: "Noto Serif TC, serif",
                              fontWeight: 200,
                            }}
                    ...
                    <p
                      className="text-center mt-1 text-[11px] text-[#31353A]/46 tracking-wider"
                      style={{
                        fontFamily: "Noto Serif TC, serif",
                        fontWeight: 200,
                      }}
                ...
                <div className="w-full xl:w-72 2xl:w-80 flex-shrink-0">
                  {selectedCard !== null && revealedCards.has(selectedCard) ? (
                    ...
                    <div className="glass-panel rounded-2xl p-6 border border-[#D1BE9B]/15 text-center">
                      ...
                      <p
                        className="text-xs tracking-[0.15em] text-[#31353A]/50"
                        style={{
                          fontFamily: "Noto Serif TC, serif",
                          fontWeight: 200,
                        }}
          ...
          {step === "reading" && (
            <div className="animate-fade-in-up">
              <div className="text-center mb-10">
                ...
                <h2
                  className="text-[15px] tracking-[0.14em] font-extralight text-[#31353A] mt-2"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 200,
                  }}
              ...
              <div className="glass-panel rounded-2xl p-8 border border-[#D1BE9B]/20 mb-8">
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <h3
                    className="text-[14px] tracking-[0.14em] text-[#31353A]/86"
                    style={{
                      fontFamily: "Noto Serif TC, serif",
                      fontWeight: 300,
                    }}
                ...
                {interpretMutation.isError && (
                  <div className="text-center py-8">
                    <p className="text-xs text-[#EAA8AC] tracking-wider">
                      解讀暫時無法取得，請稍後再試。
                    </p>
                  </div>
                )}
                {llmInterpretation && (
                  <div ref={readingResultRef}>
                    <div
                      className="prose max-w-none text-[16px] leading-[2.15] text-[#31353A]/80 tracking-wider
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="glass-panel rounded-2xl border border-[#D1BE9B]/20 p-5">
                      <div className="mb-3 flex items-start justify-between gap-3">
                        <p
                          className="text-[14px] tracking-[0.16em] text-[#8A7250]"
                          style={{
                            fontFamily: "Noto Serif TC, serif",
                            fontWeight: 400,
                          }}
                        ...
                        <span
                          className="shrink-0 rounded-full border border-[#D1BE9B]/28 bg-white/55 px-3 py-1 text-[11px] tracking-[0.14em] text-[#8A7250]"
                          style={{
                            fontFamily: "Noto Serif TC, serif",
                            fontWeight: 300,
                          }}
                        ...
                        <div className="mt-5 flex flex-col gap-3">
                          {followUpExchanges.map((item, index) => (
                            ...
                            >
                              ...
                              <p
                                className="text-[14.5px] leading-[2.1] tracking-[0.08em] text-[#31353A]/78 whitespace-pre-wrap"
                                style={{
                                  fontFamily: "Noto Sans TC, sans-serif",
                                  fontWeight: 300,
                                }}
                    ...
                    <div className="rounded-2xl border border-[#06C755]/22 bg-[#F7FFF9]/72 p-5 shadow-[0_14px_38px_rgba(38,115,69,0.07)] backdrop-blur-sm">
                      <div className="mb-3 flex items-start justify-between gap-3">
                        <div className="flex items-center gap-2 text-[#267345]">
                          ...
                          <p
                            className="text-[14px] tracking-[0.16em]"
                            style={{
                              fontFamily: "Noto Serif TC, serif",
                              fontWeight: 400,
                            }}
                        ...
                        <span
                          className="shrink-0 rounded-full border border-[#06C755]/24 bg-white/70 px-3 py-1 text-[11px] tracking-[0.14em] text-[#267345]"
                          style={{
                            fontFamily: "Noto Serif TC, serif",
                            fontWeight: 300,
                          }}
              ...
              {llmInterpretation && (
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <Link href="/quiz" className="w-full sm:w-44">
                    <button
                      className="w-full px-8 py-3 text-xs tracking-[0.25em] bg-[#3D4144] text-[#FAF7F4] rounded-full hover:bg-[#D1BE9B] hover:text-[#31353A] transition-all duration-500 active:scale-95"
                      style={{
                        fontFamily: "Noto Serif TC, serif",
                        fontWeight: 300,
                      }}
  ...
  return (
    <div
      className={`group relative w-28 h-40 cursor-pointer transition-all duration-300 ${
        isSelected
          ? "scale-110 drop-shadow-[0_10px_28px_rgba(209,190,155,0.48)]"
    ...
    >
      <div
        className={`pointer-events-none absolute -inset-1 rounded-[14px] border transition-all duration-300 ${
          isSelected
      ...
      >
        ...
        {/* Front */}
        <div
          className="absolute inset-0 rounded-[11px] drop-shadow-[0_10px_24px_rgba(49,53,58,0.16)]"
  ...
  return (
    <div className="glass-panel rounded-2xl p-5 border border-[#D1BE9B]/20 animate-fade-in-up">
      <div className="flex items-center gap-2 mb-4">
        <span
          className="text-[11px] tracking-[0.2em] px-2.5 py-1 rounded-full border border-[#D1BE9B]/30 text-[#D1BE9B]"
          style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
        >
          {position.label}
        </span>
        {drawn.reversed && (
          <span
            className="text-[11px] tracking-[0.1em] text-[#EAA8AC]"
            style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
          >
            逆位
          </span>
      ...
      <div className="flex gap-4 mb-4">
        ...
        <div>
          ...
          <h4
            className="text-sm tracking-[0.15em] text-[#31353A]/86 mb-0.5"
            style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
          >
            {drawn.card.name}
          </h4>
          <p
            className="text-[11px] italic text-[#D1BE9B] tracking-wider"
            style={{ fontFamily: "Cormorant Garamond, serif" }}
          >
            {drawn.card.en}
          </p>
      ...
      <p
        className="text-[11px] text-[#31353A]/58 tracking-wider mb-3 leading-[1.8]"
        style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 200 }}
      >
        {position.desc}
      </p>
      ...
      <div className="border-t border-[#D1BE9B]/15 pt-3">
        <p
          className="text-[12px] leading-[1.9] text-[#31353A]/72 tracking-wider"
          style={{ fontFamily: "Noto Sans TC, sans-serif", fontWeight: 300 }}
        >
