          ...
          {!astrolabe ? (
            ...
            <div className="max-w-lg mx-auto animate-fade-in-up">
              <div className="glass-panel rounded-2xl p-8 border border-[#D1BE9B]/20">
                <h2 className="text-sm tracking-[0.2em] text-[#3D4144]/75 mb-6 text-center"
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border text-xs tracking-[0.15em] transition-all duration-200 ${
                          gender === g.id
                            ...
                            : 'border-[#D1BE9B]/20 text-[#3D4144]/55 hover:border-[#D1BE9B]/40'
                        }`}
                        style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    min="1900-01-01"
                    className="w-full bg-white/50 border border-[#D1BE9B]/25 rounded-xl px-4 py-2.5 text-xs text-[#3D4144]/70 tracking-wider focus:outline-none focus:border-[#D1BE9B]/50"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
                  />
                  <p className="mt-1.5 text-[9px] text-[#3D4144]/35 tracking-wider"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                ...
                <div className="mb-5">
                  ...
                  <select
                    ...
                    className="w-full bg-white/50 border border-[#D1BE9B]/25 rounded-xl px-4 py-2.5 text-xs text-[#3D4144]/70 tracking-wider focus:outline-none focus:border-[#D1BE9B]/50 appearance-none"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                    {HOURS.map(h => (
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-white/50 border border-[#D1BE9B]/25 rounded-xl px-4 py-2.5 text-xs text-[#3D4144]/70 tracking-wider focus:outline-none focus:border-[#D1BE9B]/50 resize-none placeholder:text-[#3D4144]/25"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 text-xs tracking-[0.25em] bg-[#3D4144] text-[#FAF7F4] rounded-full hover:bg-[#D1BE9B] hover:text-[#3D4144] transition-all duration-500 active:scale-95 disabled:opacity-60"
                  style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                {[
                  ...
                  <div key={item.label} className="glass-panel rounded-xl px-4 py-2.5 border border-[#D1BE9B]/20 text-center">
                    ...
                    <p className="text-xs tracking-[0.1em] text-[#3D4144]/75"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                      {item.value}
                    </p>
                  </div>
              ...
              <div className="flex flex-col xl:flex-row gap-8 items-start">
                ...
                <div className="flex-1">
                  ...
                  >
                        ...
                        >
                          ...
                          {isLife && (
                            <div className="absolute top-1.5 right-1.5 w-4 h-4 rounded-full bg-[#D1BE9B]/60 flex items-center justify-center">
                              <span className="text-[7px] text-[#3D4144]">命</span>
                            </div>
                          )}
                          ...
                          <div className="mb-1.5">
                            <p className="text-[10px] tracking-[0.15em] text-[#3D4144]/80"
                              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                              {palace.name}
                            </p>
                            <p className="text-[8px] tracking-wider text-[#3D4144]/35"
                              style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                          ...
                          <div className="flex flex-wrap gap-1">
                            ...
                            {palace.majorStars.length === 0 && (
                              <span className="text-[8px] text-[#3D4144]/25 tracking-wider"
                                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                                空宮
                              </span>
                            )}
                          ...
                          {palace.minorStars.slice(0, 2).length > 0 && (
                            <div className="mt-1 flex flex-wrap gap-0.5">
                              {palace.minorStars.slice(0, 2).map(s => (
                                <span key={s.name} className="text-[7px] text-[#3D4144]/35"
                                  style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                                  {s.name}
                                </span>
                              ))}
                          ...
                          <div className="absolute bottom-1.5 right-2">
                            <span className="text-[7px] text-[#3D4144]/30"
                              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                    ...
                    >
                      <div className="text-center p-4">
                        ...
                        <p className="text-[10px] tracking-[0.2em] text-[#3D4144]/50"
                          style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                          {astrolabe.solarDate}
                        </p>
                        ...
                        <p className="text-[8px] tracking-[0.1em] text-[#3D4144]/35 mt-2"
                          style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                          {gender}命
                        </p>
                      </div>
                  ...
                  <p className="text-center mt-3 text-[9px] tracking-[0.15em] text-[#3D4144]/35"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                    點擊宮位查看詳細解讀
                  </p>
                </div>
                ...
                <div className="xl:w-72">
                    ...
                    <div className="glass-panel rounded-2xl p-6 border border-[#D1BE9B]/20 animate-fade-in-up">
                      <div className="flex items-center gap-2 mb-4">
                        <div className="w-8 h-8 rounded-full flex items-center justify-center"
                          ...
                          <span className="text-[10px] text-[#3D4144]/70"
                            style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                        ...
                        <div className="border-t border-[#D1BE9B]/15 pt-3 mt-3">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {selectedPalace.minorStars.map(s => (
                              <span key={s.name} className="text-[8px] px-1.5 py-0.5 rounded-full bg-[#D1BE9B]/10 text-[#3D4144]/50 border border-[#D1BE9B]/20"
                                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                                {s.name}
                              </span>
                            ))}
                      ...
                      {selectedPalace.majorStars.length === 0 && (
                        <div className="border-t border-[#D1BE9B]/15 pt-4">
                          <p className="text-[11px] leading-[1.9] text-[#3D4144]/45 tracking-wider italic"
                            style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                            此宮為空宮，代表此方面的事務較為自由，
                  ...
                  <div className="mt-4 glass-panel rounded-xl p-4 border border-[#D1BE9B]/15">
                    ...
                    <p className="text-xs tracking-[0.1em] text-[#3D4144]/70 mb-1"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                      {gender === '女' ? '紫水晶 × 月光石' : '黃水晶 × 黑碧璽'}
                    </p>
                    <p className="text-[10px] leading-[1.8] text-[#3D4144]/50 tracking-wider mb-3"
                      style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}>
                      {gender === '女'
                        ? '增強直覺力，平衡陰性能量，提升靈性感知'
                        : '強化行動力，穩定根輪能量，防護負面磁場'}
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    ...
                    <Link href="/treehole">
                      <button className="w-full py-2.5 text-xs tracking-[0.2em] bg-[#3D4144] text-[#FAF7F4] rounded-full hover:bg-[#D1BE9B] hover:text-[#3D4144] transition-all duration-500 active:scale-95"
                        style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                        與 AI 深入探討命盤
                      </button>
                    </Link>
              ...
              <div className="glass-panel rounded-2xl p-6 border border-[#D1BE9B]/20">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="text-[12px] tracking-[0.2em] text-[#3D4144]/80"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                    命盤整體解讀
                  </h4>
                </div>
                {interpretMutation.isPending && (
                  <div className="flex flex-col items-center py-8 gap-3">
                    ...
                    <p className="text-[10px] tracking-[0.15em] text-[#3D4144]/40"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                      正在解讀你的命盤...
                    </p>
                  </div>
                ...
                {!interpretMutation.isPending && !interpretMutation.isError && !llmInterpretation && (
                  <p className="text-[11px] text-[#3D4144]/35 tracking-wider text-center py-4"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                    排盤完成後將自動生成 AI 命盤解讀
                  </p>
                )}
                {llmInterpretation && (
                  <div className="text-[12px] leading-[2.2] text-[#3D4144]/65 tracking-wider"
                    style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}>
