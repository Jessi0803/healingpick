        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-1 mb-1">
            <div className="min-w-0">
              <span className="text-[9px] tracking-[0.12em] px-1.5 py-0.5 rounded-full bg-white/70 text-[#6F5A3A] border border-[#D1BE9B]/20"
              ...
              <div className="mt-6 pt-6 border-t border-[#D1BE9B]/15">
                ...
                <div className="flex flex-col gap-3">
                  {ziweiRecommendedProducts[0] && (
                    <ProductCard key={ziweiRecommendedProducts[0].slug} product={ziweiRecommendedProducts[0]} context={ziweiRecommendationMessage} role="primary" />
                  )}
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {ziweiRecommendedProducts.slice(1).map((product) => (
                          <ProductCard key={product.slug} product={product} context={ziweiRecommendationMessage} role="secondary" />
                        ))}
                      </div>
                    </>
                  )}
