    ...
    return (
      <PageLayout>
        <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
          ...
          <h2
            className="text-xl tracking-[0.2em] font-light text-[#31353A] mb-4"
          ...
          <Link href="/shop">
            <button
              className="px-6 py-2.5 text-xs tracking-[0.2em] bg-[#3D4144] text-[#FAF7F4] rounded-full hover:bg-[#D1BE9B] hover:text-[#31353A] transition-all duration-500"
              style={{ fontFamily: "Noto Serif TC, serif" }}
            >
              返回能量商店
            </button>
    ...
    <div className="mb-12 animate-fade-in-up">
      <div className="flex items-center justify-between gap-4 mb-5 flex-wrap">
        <div className="flex items-center gap-3">
          <span
            className="text-[10px] tracking-[0.3em] text-[#D1BE9B] uppercase"
      ...
      <div className="relative max-w-3xl rounded-3xl border border-[#D1BE9B]/25 bg-gradient-to-br from-white/60 to-[#FAF0EC]/40 px-6 py-8 md:px-10 md:py-10 shadow-[0_6px_24px_rgba(209,190,155,0.10)] overflow-hidden">
        ...
        <span className="absolute top-3 left-4 text-[12px] text-[#D1BE9B]/40 select-none">
          𓆩♡𓆪
        </span>
        <span className="absolute bottom-3 right-5 text-[12px] text-[#D1BE9B]/40 select-none">
          𓂃𓈒𓏸
        </span>

        <div className="flex flex-col items-center gap-4 text-center">
          <span className="text-[10px] text-[#D1BE9B]/70 select-none tracking-wider">
            ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
          </span>

          <p
            className="text-[13.5px] md:text-[14px] leading-[2.3] text-[#31353A]/80 tracking-wider whitespace-pre-line text-left w-full px-2"
            style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
          >
            {product.story}
          </p>
      ...
      <div className="min-h-screen py-12 px-4 md:px-8 bg-[#FAF7F4]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in-up">
            <Link href="/shop">
              <button
                className="inline-flex items-center gap-2 group text-xs tracking-[0.2em] text-[#31353A]/62 hover:text-[#31353A] transition-all duration-300 bg-transparent border-none focus:outline-none"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start mb-12 animate-fade-in-up">
            ...
            <div className="w-full md:w-1/2">
              <div className="aspect-square relative overflow-hidden rounded-3xl border border-[#D1BE9B]/20 shadow-[0_8px_32px_rgba(209,190,155,0.15)] bg-white/40">
                <ProductImageWatermark
                  ...
                  watermarkClassName="bottom-4 right-4 px-3 py-1.5 text-[11px]"
                />
                {product.tag && (
                  <span
                    className="absolute top-4 left-4 text-[10px] tracking-[0.15em] px-3 py-1 rounded-full bg-[#D1BE9B]/90 text-[#31353A] shadow-sm"
                    style={{
            ...
            <div className="w-full md:w-1/2">
              <div className="flex items-center gap-1.5 mb-2.5 select-none">
                <span className="text-[10px] text-[#D1BE9B]/80 font-light select-none tracking-wider">
                  ✦ ⋆ ˚｡𖦹 ⋆｡°✩
                </span>
              </div>
              <p
                className="text-[10px] tracking-[0.25em] text-[#8F7957] mb-3 uppercase"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {product.material}
              </p>
              ...
              <h1
                className="text-2xl md:text-3xl tracking-[0.18em] text-[#31353A] font-extralight mb-5"
              ...
              <p
                className="text-[13px] leading-[2] text-[#31353A]/72 tracking-wider whitespace-pre-line mb-6"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {product.tagline}
              </p>
              ...
              <div className="mb-4 rounded-2xl border border-[#D1BE9B]/20 bg-white/45 px-4 py-3">
                <p
                  className="text-[10px] tracking-[0.22em] text-[#A38D6B] mb-1"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 300,
                  }}
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="leading-[1.7]">
                          <span
                            className="text-[12.5px] tracking-[0.06em] text-[#A38D6B]"
                            style={{
                              fontFamily: "Noto Serif TC, serif",
                              fontWeight: 400,
                            }}
              ...
              {product.suitedFor.map((s, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className="text-[12px] tracking-[0.08em] text-[#31353A]/85 leading-[1.9]"
                      style={{
                        fontFamily: "Noto Serif TC, serif",
                        fontWeight: 300,
                      }}
          ...
          <Section title="商品詳情 / 材質說明" subtitle="Material" icon="✦">
            <div className="grid gap-3 md:grid-cols-3">
              <div className="rounded-2xl border border-[#D1BE9B]/20 bg-white/45 px-4 py-4 md:col-span-1">
                ...
                <p
                  className="text-[13px] leading-[1.8] tracking-[0.08em] text-[#31353A]/78"
                  style={{
                    fontFamily: "Noto Serif TC, serif",
                    fontWeight: 300,
                  }}
              ...
              <div className="rounded-2xl border border-[#D1BE9B]/20 bg-white/45 px-4 py-4 md:col-span-2">
                ...
                <p
                  className="text-[12.5px] leading-[1.9] tracking-[0.06em] text-[#31353A]/70"
                  style={{
                    fontFamily: "Noto Sans TC, sans-serif",
                    fontWeight: 300,
                  }}
                >
                  銀飾款式依設計不同，可能使用 14K
                  包金、純銀或鍍銀材質。若日常配戴會頻繁碰水，建議優先選擇金飾款，保養上會更安心。
                </p>
              </div>
            </div>
          </Section>
          ...
          <div className="w-full max-w-3xl mx-auto mt-8 mb-16 animate-fade-in-up">
            <div className="glass-panel bg-white/45 backdrop-blur-sm border border-[#D1BE9B]/20 p-8 md:p-12 rounded-3xl shadow-[0_12px_40px_rgba(209,190,155,0.08)] relative overflow-hidden">
              ...
              <p
                className="text-[10px] tracking-[0.35em] text-[#D1BE9B] text-center mb-2 uppercase flex items-center justify-center gap-2"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 200 }}
              >
                <span className="text-[#D1BE9B]/80 text-[11px] select-none">
                  𓆩♡𓆪
                </span>
                Healing Pick 想對你說
                <span className="text-[#D1BE9B]/80 text-[11px] select-none">
              ...
              <p
                className="text-[13.5px] md:text-[14px] leading-[2.2] text-[#31353A]/80 tracking-wider whitespace-pre-line text-center"
                style={{ fontFamily: "Noto Serif TC, serif", fontWeight: 300 }}
              >
                {product.closing}
              </p>
  ...
  return (
    <div className="mb-10 animate-fade-in-up">
      <div className="flex items-center justify-between gap-4 mb-5 flex-wrap">
        <div className="flex items-center gap-3">
          <span
            className="text-[13px] tracking-[0.06em] text-[#A38D6B] italic"
