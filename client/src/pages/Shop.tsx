        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-3 items-center justify-between">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-[10px] tracking-[0.15em] border transition-all duration-200 ${
                      typeFilter === t.id
                        ...
                        : 'border-[#D1BE9B]/20 text-[#3D4144]/50 hover:border-[#D1BE9B]/35'
                    }`}
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                    {t.label}
                  </button>
              ...
              <select
                ...
                className="bg-white/40 border border-[#D1BE9B]/20 rounded-full px-4 py-1.5 text-[10px] text-[#3D4144]/60 tracking-wider focus:outline-none appearance-none"
                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
            ...
            {filtered.map((product, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <h3 className="text-xs tracking-[0.12em] text-[#3D4144]/80 mb-0.5"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                    {product.name}
                  </h3>
                  <p className="text-[9px] italic text-[#3D4144]/40 mb-1.5"
                    style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                    {product.subtitle}
                  </p>
                  <div className="flex items-center gap-2">
                    ...
                    {product.originalPrice && (
                      <span className="text-[9px] text-[#3D4144]/30 line-through"
                        style={{ fontFamily: 'Cormorant Garamond, serif' }}>
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-4">
              ...
              <p className="text-[10px] text-[#3D4144]/40 tracking-wider italic"
                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                每顆水晶都經過 Mochi 的篩選 ✦
              </p>
              <CatSitting className="w-10 h-14" />
          ...
          <div className="glass-panel rounded-2xl p-8 border border-[#D1BE9B]/20 text-center">
            ...
            <h3 className="text-lg tracking-[0.15em] text-[#3D4144]/75 mb-3"
              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
              你有水晶或靈性商品想上架嗎？
            </h3>
            <p className="text-[11px] leading-[2] text-[#3D4144]/50 tracking-wider mb-5 max-w-md mx-auto"
      ...
      {selectedProduct && (
        ...
        >
          ...
          >
            {/* Close */}
            <button
              className="absolute top-4 right-4 z-10 w-8 h-8 rounded-full bg-white/70 flex items-center justify-center text-[#3D4144]/50 hover:text-[#3D4144] transition-colors"
              onClick={() => setSelectedProduct(null)}>
              ✕
            </button>
              ...
              <div className="md:w-1/2 p-6 md:p-8">
                ...
                <div className="flex gap-2 mb-3">
                  <span className={`text-[8px] tracking-[0.1em] px-2 py-0.5 rounded-full ${
                    selectedProduct.type === 'self' ? 'bg-[#D1BE9B]/30 text-[#A38D6B]' : 'bg-[#E8EDE5] text-[#3D4144]/60'
                  }`} style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                    {selectedProduct.type === 'self' ? '自營商品' : '合作商品'}
                  </span>
                  {selectedProduct.tag && (
                    <span className="text-[8px] tracking-[0.1em] px-2 py-0.5 rounded-full bg-[#3D4144]/10 text-[#3D4144]/60"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                      {selectedProduct.tag}
                    </span>
                  )}
                ...
                <h2 className="text-lg tracking-[0.15em] text-[#3D4144]/80 mb-0.5"
                  style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  {selectedProduct.originalPrice && (
                    <span className="text-sm text-[#3D4144]/30 line-through"
                      style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                ...
                {/* Description */}
                <p className="text-[10px] leading-[2] text-[#3D4144]/55 tracking-wider mb-4"
                  style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}>
                ...
                <div className="grid grid-cols-2 gap-2 mb-5">
                  {[
                    ...
                    <div key={spec.label} className="bg-[#D1BE9B]/8 rounded-lg p-2">
                      ...
                      <p className="text-[10px] tracking-[0.1em] text-[#3D4144]/65"
                        style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}>
                        {spec.value}
                      </p>
                    </div>
                ...
                <p className="text-center mt-2 text-[9px] text-[#3D4144]/30 tracking-wider"
                  style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}>
                  ✦ 每顆水晶皆附能量淨化說明書
                </p>
              </div>
