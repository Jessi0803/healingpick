        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-3 items-center">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col items-start">
              <span
                className="font-en-serif text-xl md:text-2xl tracking-[0.25em] font-light text-[#3D4144]/90 group-hover:text-[#D1BE9B] transition-colors duration-300"
                style={{ fontFamily: 'Cormorant Garamond, serif' }}
              >
                Healing Pick
              </span>
              <span
                className="text-[9px] tracking-[0.3em] text-[#3D4144]/45 mt-0.5"
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-xs tracking-[0.2em] transition-colors duration-300 ${
                  isActive(link.href)
                    ? 'text-[#D1BE9B]'
                    : 'text-[#3D4144]/75 hover:text-[#D1BE9B]'
                }`}
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            {isAuthenticated ? (
              <div className="hidden lg:flex items-center gap-3">
                ...
                <button
                  ...
                  className="text-xs tracking-[0.2em] text-[#3D4144]/50 hover:text-[#D1BE9B] transition-colors duration-300"
                  style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
                >
                  登出
                </button>
              ...
              <a
                href={getLoginUrl()}
                className="hidden lg:block text-xs tracking-[0.2em] text-[#3D4144]/75 hover:text-[#D1BE9B] transition-colors duration-300"
                style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
              >
                登入
              </a>
            ...
            {/* Hamburger */}
            <button
              className="lg:hidden p-2 text-[#3D4144]/70 hover:text-[#D1BE9B] transition-colors"
              ...
              <div className="mt-4 pt-4 border-t border-[#D1BE9B]/20 flex flex-col gap-2">
                {isAuthenticated ? (
                  <>
                    <Link
                      href="/history"
                      className="text-xs tracking-[0.25em] text-[#3D4144]/75 hover:text-[#D1BE9B] transition-colors py-2"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
                    >
                      ✦ 我的紀錄
                    </Link>
                    <button
                      onClick={() => logoutMutation.mutate()}
                      className="text-left text-xs tracking-[0.25em] text-[#3D4144]/50 hover:text-[#D1BE9B] transition-colors py-2"
                      style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
                    >
                      登出
                    </button>
