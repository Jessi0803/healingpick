...
const PEARLS: Pearl[] = [
  ...
  // 塔羅小知識(配連結到 /tarot)
  {
    text: '塔羅是用 22 張牌幫你看「現在的狀態」—— 抽出來的牌組合起來,像在跟你說一段話。',
    cta: { label: '抽 5 張看看 →', href: '/tarot' },
  },
  {
    text: '抽到的牌如果是顛倒的,叫做「逆位」,意思會跟正放時不太一樣 —— 提醒你換個角度看。',
  ...
  {
    text: '命宮是命盤裡最重要的一格,看你「天生是怎樣的人」、適合什麼樣的生活。',
    cta: { label: '排盤試試 →', href: '/ziwei' },
  },
  {
    text: '紫微斗數的「紫微」是一顆主星,它落在哪個宮位,你那方面就會特別有氣場。',
    cta: { label: '查你的紫微 →', href: '/ziwei' },
  },
  {
    text: '命盤不會說「未來一定發生什麼」,而是看你「天生帶著什麼條件、適合走怎樣的路」。',
    cta: { label: '看你的命盤 →', href: '/ziwei' },
  },
];
