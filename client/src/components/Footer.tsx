    ...
    <footer className="relative bg-[#F2EDE8] border-t border-[#D1BE9B]/20 py-14 px-6 md:px-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="mb-4">
              ...
              <div
                className="text-[11px] tracking-[0.3em] text-[#31353A]/40 mt-1"
            ...
            <p
              className="text-[12px] leading-[2] text-[#31353A]/55 max-w-xs tracking-wider"
              style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 200 }}
            >
              有些心事，只需要一個溫柔的出口。<br />
              在這裡，讓星象與水晶陪伴你，<br />
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-[12px] tracking-[0.15em] text-[#31353A]/55 hover:text-[#D1BE9B] transition-colors duration-300"
                    style={{ fontFamily: 'Noto Serif TC, serif', fontWeight: 300 }}
                  >
                    {item.label}
                  </Link>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
          <p
            className="text-[11px] tracking-[0.15em] text-[#31353A]/35"
            style={{ fontFamily: 'Noto Sans TC, sans-serif', fontWeight: 300 }}
          >
            © 2025 SOUL EASE 能量聖所 All rights reserved.
          </p>
          <p
            className="text-[11px] tracking-[0.15em] text-[#31353A]/30 italic"
            style={{ fontFamily: 'Cormorant Garamond, serif' }}
          >
