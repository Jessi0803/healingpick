...
export const CUSTOM_BRACELET_RECOMMENDATION_PRODUCT: Product = {
  ...
  originalPrice: null,
  tag: '客製款',
  fitSummary: '把你的狀態、喜歡的色系與想加強的招財、桃花、守護或勇氣方向,整理成一條專屬手鍊。',
  ...
  meanings: [
    ...
    { emoji: '💎', title: '能量整合', desc: '把不同需求放進同一條日常手鍊,讓每顆水晶都有自己的角色。' },
    { emoji: '🌙', title: '貼近日常', desc: '讓配戴習慣、色系、尺寸與能量寓意都更合適。' },
  ],
  suitedFor: [
    '現有款式都只中一部分,想把自己的狀態整理成更專屬的水晶搭配',
    '有明確想加強的招財、桃花、守護或勇氣方向,也希望色系與手圍都剛好合適',
    '看完占卜或近期狀態整理後,想把那份提醒變成每天都能戴著的配戴物',
  ],
  story:
...
export const PRODUCTS: Product[] = [
  ...
  // ── 微光守護狐 (茶晶琉璃) ─────────────────────────────────────────────────
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '微光守護狐適合放在容易被外界影響的日子裡,提醒你把守護界線與安全感慢慢放回身邊。',
    gentleRecommendation:
    ...
    meanings: [
      { emoji: '🤎', title: '茶晶琉璃', desc: '在這款裡負責沉穩與落地感,適合想把安全感放回生活角落的人。' },
      { emoji: '☁️', title: '九尾狐', desc: '作為整體守護意象,帶來理性與清晰的能量,也寓意智慧與內在力量。' },
      { emoji: '🌙', title: '守護界線', desc: '把重點放在避開消耗型人事物,提醒你把該保持的距離穩穩站好。' },
      { emoji: '🦋', title: '穩定前進', desc: '在守護之外補上一份安定感,陪你一步一步回到自己的節奏。' },
      { emoji: '🌷', title: '自我照顧', desc: '把守護感落回自己身上,不是要你變得更強硬,而是提醒你也值得被好好照顧。' },
    ],
    suitedFor: [
      '最近常覺得被工作、人際或外界聲音消耗,想把注意力慢慢收回自己身上',
      '想加強守護界線與安全感,提醒自己不需要什麼都接住、什麼都答應',
      '喜歡九尾狐的溫柔守護氣質,希望桌邊或床頭有一個安靜陪伴的角色',
      '想送自己或重要的人一份有儀式感、也有守護寓意的小物',
    ],
    story:
  ...
  // ── 心願九尾狐 (幻彩琉璃) ─────────────────────────────────────────────────
  {
    ...
    meanings: [
      ...
      { emoji: '🦋', title: '幸運陪伴', desc: '把桃花與心願往行動延伸,加入一份勇敢前行的力量感,提醒你也要相信自己。' },
      { emoji: '☁️', title: '自我照顧', desc: '提醒自己不用追著誰的喜歡跑,先把自己的光找回來。' },
      { emoji: '🫧', title: '心願守護', desc: '陪伴你專注於想完成的目標與夢想,把心願好好收著。' },
    ],
    suitedFor: [
      '想招桃花、提升人緣與個人魅力,但不想靠討好別人來換取喜歡',
      '正在期待新的緣分、善緣或機會,希望自己能更自然地被看見',
      '喜歡九尾狐與幻彩光感,想在房間或工作區放一個有心願感的擺飾',
      '想為自己準備一份小禮物,提醒自己先把光放回身上',
    ],
    story:
  ...
  // ── 勇氣小貓 (虎眼石) ─────────────────────────────────────────────────────
  {
    ...
    meanings: [
      ...
      { emoji: '🌷', title: '行動力', desc: '把勇氣落到日常行動裡,適合想先踏出一小步、慢慢推進目標的人。' },
      { emoji: '☁️', title: '安放心緒', desc: '替勇氣補上一點緩衝,在想太多或猶豫時提醒自己先停一下,再回到可以前進的節奏。' },
      { emoji: '🍀', title: '好運能量', desc: '讓勇氣不只是用力衝刺,也包含願意迎接新機會的心態。' },
      { emoji: '🤍', title: '小貓陪伴', desc: '像小貓一樣安靜地守護著你,讓勇氣不必用力張揚。' },
    ],
    suitedFor: [
      '心裡有想開始的事,但常常卡在第一步,需要一個提醒自己行動的小陪伴',
      '希望提升自信與行動力,把想法慢慢落到日常裡',
      '近期想為自己增添勇敢前行的力量感,不求一次很勇敢,只想先往前一點',
      '喜歡可愛但不幼稚的能量系擺飾,想送自己一份鼓勵與祝福',
    ],
    story:
  ...
  // ── 願望小兔 (白水晶) ─────────────────────────────────────────────────────
  {
    ...
    meanings: [
      { emoji: '🤍', title: '白水晶', desc: '在這款裡負責清透與整理,讓願望感不漂浮,而是回到單純的初心。' },
      ...
      { emoji: '🦋', title: '幸福陪伴', desc: '把願望感放回日常細節裡,提醒你把生活中的小確幸一點一滴收藏起來。' },
    ],
    suitedFor: [
      '正準備開始新的計畫,想先替心裡的期待留一個位置',
      '有些願望還沒說出口,但希望自己不要因為忙碌就把它忘記',
      '喜歡白水晶與小兔造型,想要一個乾淨、溫柔又帶好運寓意的小物',
      '想送自己一份輕柔的鼓勵,提醒自己美好可以慢慢靠近',
    ],
    story:
  ...
  // ── 靜心之光・白菘石柱 (白菘石) ───────────────────────────────────────────
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '靜心之光適合放在書桌或床邊,陪你把太滿的思緒放慢,也替日常留一個安靜角落。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '🌙', title: '放慢節奏', desc: '把「不用急著處理完全部事情」變成桌邊提醒,陪你在日常中放慢節奏。' },
      { emoji: '🫧', title: '專注內在', desc: '帶來理性與清晰的能量,陪伴整理思緒與專注內在。' },
      { emoji: '🌷', title: '自我照顧', desc: '練習照顧自己的心緒與感受,不急著把所有事情一次處理完。' },
    ],
    suitedFor: [
      '最近腦中事情很多,想在書桌或床邊留一個讓思緒慢慢沉澱的位置',
      '希望整理生活節奏,提醒自己不用急著把所有事情一次處理完',
      '喜歡冥想、閱讀或寫日記,也想讓那個角落多一點安定感',
      '正在學習照顧自己的感受,想用一個小擺件提醒自己放慢一點',
    ],
    story:
  ...
  // ── 月光守護之翼 (拉長石) ─────────────────────────────────────────────────
  {
    ...
    meanings: [
      { emoji: '☁️', title: '拉長石', desc: '在這款裡負責智慧與方向感,帶來理性與清晰的能量,陪伴整理思緒與專注內在。' },
      { emoji: '🌙', title: '直覺提醒', desc: '替拉長石的智慧能量補上內在聆聽,當外界意見很多時,提醒你先安靜聽見自己真正的想法。' },
      { emoji: '🦋', title: '靈感與創造力', desc: '把方向感延伸成新的想法與可能性,適合正在確認下一步的人。' },
      { emoji: '🤍', title: '羽翼守護', desc: '把智慧與勇氣連在一起,象徵陪伴與守護,也為自己增添一份勇敢前行的力量感。' },
      { emoji: '✨', title: '願望與希望', desc: '把守護與方向感收在星月意象裡,在迷惘時提醒自己仍然可以相信未來。' },
    ],
    suitedFor: [
      '正在確認下一步方向,想讓自己在很多意見裡聽見真正的想法',
      '喜歡塔羅、星月與直覺探索,也希望判斷裡多一點理性與清晰',
      '想增加自信與守護感,提醒自己可以相信直覺,也可以穩穩前進',
      '想找一件不只是好看,也帶有智慧、方向與陪伴寓意的飾品',
    ],
    story:
  ...
  // ── 財運礦 ────────────────────────────────────────────────────────────────
  {
    ...
    suitedFor: [
      ...
      '想送給創業中、轉職中或正在努力累積的人一份實際又有祝福感的禮物',
    ],
    story:
  ...
  // ── 森蘊 ────────────────────────────────────────────────────────────────
  {
    ...
    suitedFor: [
      ...
      '喜歡自然綠色系與清透層次,想要一條穩穩累積、不急躁的招財手鍊',
    ],
    story:
  ...
  // ── 靈狐星願 ────────────────────────────────────────────────────────────
  {
    ...
    suitedFor: [
      ...
      '喜歡粉色系與狐仙元素,想要甜感但不過度張揚的日常手鍊',
      '心裡正在收藏一個小願望,希望穿搭裡也有一點柔光和儀式感',
    ],
    story:
  ...
  // ── 霧裡星光 ────────────────────────────────────────────────────────────
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '霧裡星光把招桃花、人緣與溫柔守護串成柔光,適合想在關係裡保有甜感也保有界線的人。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '🍓', title: '草莓晶', desc: '補上好人緣與愉悅互動感,讓粉晶的甜更靠近日常關係連結。' },
      { emoji: '🤍', title: '白水晶', desc: '負責整理粉晶與草莓晶的甜感,讓整體更清透、不顯厚重。' },
      { emoji: '🌙', title: '藍月光', desc: '替桃花與人緣補上一份安定與柔和,提醒自己先停一下,再好好回應。' },
      { emoji: '✨', title: '拉長石', desc: '帶來理性與清晰的能量,陪伴整理思緒與專注內在,讓溫柔也保有界線。' },
    ],
    suitedFor: [
      '想招桃花、提升感情與人際關係,但也希望自己在關係裡不要失去界線',
      '正在練習先好好愛自己,不想把所有期待都放在別人的回應上',
      '喜歡柔光、乾淨、氣質款手鍊,希望日常配戴有溫柔守護感',
      '想送自己一份關係提醒:可以柔軟,也可以保留自己的位置',
    ],
    story:
  ...
  // ── 2026 Drive import ───────────────────────────────────────────────────
  {
    ...
    meanings: [
      { emoji: '✨', title: '淨體鈦晶', desc: '在這條裡負責智慧與行動主軸,帶來理性與清晰的能量,陪伴整理思緒與專注內在。' },
      { emoji: '☀️', title: '清晰思緒', desc: '把鈦晶的光感落到計畫與判斷上,適合想把方向與下一步慢慢看清楚的人。' },
    ...
    suitedFor: [
      ...
      '喜歡清透但帶金色光澤的手鍊,想要明亮卻不張揚的存在感',
      '適合工作、讀書或重要決定前配戴,提醒自己理性、清晰、穩穩行動',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '光羽之境把避小人與溫柔守護做成黑金光感,適合想在複雜人事裡站穩界線的人。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '🤍', title: '白水晶', desc: '負責調和整體配戴感,讓黑金守護不顯沉重,也讓光感更清楚。' },
      { emoji: '🤎', title: '茶晶', desc: '補上沉穩與落地感,提醒自己把界線站穩,不要被外界拉走。' },
    ],
    suitedFor: [
      '工作或人際環境有點複雜,想加強避小人與守護界線的提醒',
      '容易被別人的情緒、話語或眼光影響,想把注意力收回自己',
      '喜歡黑金、白色與月光感搭配,想要沉穩但不厚重的守護款',
      '想把自己的狀態整理成一條帶客製感、日常也好搭的手鍊',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '狐語微甜把招桃花、人緣與微甜守護藏進小狐意象裡,讓日常多一點親和與亮光。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '🌸', title: '膠花晶', desc: '用柔軟色彩增加親和與好感度,讓日常互動更有微甜氣質。' },
    ],
    suitedFor: [
      '想招桃花、提升人緣與親和感,但喜歡微甜、不過度張揚的感覺',
      '希望自己在人際互動裡更柔和,也更容易被舒服的人靠近',
      '喜歡狐仙意象與黃水晶的明亮感,想讓桃花之外也帶一點招財寓意',
      '容易把自己繃太緊,想用一條輕盈的手鍊提醒自己慢慢來',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '焦糖瑪奇朵像一杯剛剛好的暖飲,把安放心緒、奶金溫柔與日常百搭都留在手腕上。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '☕', title: '奶金色調', desc: '把月光石與茶晶串成剛剛好的暖意,日常、工作或約會都容易搭配。' },
      { emoji: '🤍', title: '柔和存在', desc: '把月光石與茶晶的溫潤感收在一起,這條的重點不是張揚,而是越看越舒服的陪伴感。' },
    ],
    suitedFor: [
      '喜歡奶茶、焦糖與溫柔棕金色系,想要一條不挑場合的日常手鍊',
      '平常穿搭偏低調,但希望手上有一點溫暖、細緻的光感',
      '想在忙碌或心緒起伏時,提醒自己先放慢一點、穩穩回到日常',
      '偏愛柔和但有細節的設計,不想太甜,也不想太冷',
    ],
    story:
  ...
  },
  {
    ...
    meanings: [
      ...
      { emoji: '💙', title: '藍晶石', desc: '負責智慧與清晰主軸,帶來理性與清晰的能量,陪伴整理思緒與專注內在。' },
      { emoji: '🌊', title: '海藍寶', desc: '把清晰延伸到溝通表達,陪你先整理心裡的話,再慢慢說出口。' },
      { emoji: '☁️', title: '霧海藍寶', desc: '在藍色系裡補上柔霧層次,讓溝通感更溫和、不尖銳。' },
    ],
    suitedFor: [
      '心裡常有很多話和想法,希望先整理清楚,再好好表達',
      '想要招財守護的寓意,但不想選太強烈或太厚重的款式',
      '希望溝通更柔和清楚,在說真話時也保留溫度',
      '喜歡藍色、海洋感與清透層次,想要一條安靜但有質感的手鍊',
    ],
    story:
  ...
  },
  {
    ...
    suitedFor: [
      ...
      '喜歡金色系,但不想要太浮誇、太高調的視覺感',
      '希望日常搭配多一點亮點,讓手鍊看起來有光但仍然好搭',
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '莓語心願把招桃花、好人緣與甜感心願戴成草莓色,適合想讓生活多一點柔軟亮點的人。',
    gentleRecommendation:
    ...
    meanings: [
      { emoji: '🍓', title: '草莓晶', desc: '在這條裡負責甜感與好人緣,讓日常互動多一點輕盈可愛的吸引力。' },
      { emoji: '🌿', title: '綠幽靈', desc: '把桃花人緣之外的成長與累積放進來,適合正在慢慢長出成果的人。' },
      { emoji: '🌸', title: '粉晶', desc: '補強招桃花與親和魅力,讓柔軟變成自然吸引力。' },
      { emoji: '🤍', title: '白水晶', desc: '負責整理整體甜感,讓草莓色系保持清爽,不會過度厚重。' },
    ],
    suitedFor: [
      '想招桃花、提升好人緣,也想讓生活多一點甜甜的色彩',
      '喜歡草莓色系與柔光質感,但不想要太膩或太幼的設計',
      '希望自己在人際裡更自然親切,讓互動多一點輕鬆感',
      '想要一條清甜但不膩的日常款,上班、約會或出門都能戴',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '暖語把人緣、安放心緒與溫柔陪伴揉進暖色系裡,適合想慢慢接住自己的日子。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '❤️', title: '紅石榴', desc: '把暖色系的熱度往內在力量延伸,提醒自己也可以堅定地往前走。' },
      { emoji: '🌙', title: '奶油月光', desc: '在茶晶與粉晶之間補上安定與柔和,帶來安定感的配戴寓意。' },
    ],
    suitedFor: [
      '正在整理人際與心緒,想讓自己在關係裡慢慢站穩一點',
      '希望多一點溫柔陪伴,但不是被推著振作,而是先好好接住自己',
      '喜歡茶晶、粉晶與月光石搭配,想要溫暖、有層次又不過甜的手鍊',
      '適合在覺得有點累的日子配戴,提醒自己今天也值得被好好照顧',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '蔚藍微光像一點海風,陪你把溫柔溝通與清晰思緒戴得清爽、輕盈又日常。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '💙', title: '藍晶石', desc: '補上智慧與清晰主軸,帶來理性與清晰的能量,陪伴整理思緒與專注內在。' },
      { emoji: '🫧', title: '蛋白石', desc: '用細碎波光增加輕盈與靈動感,讓藍色系不只安靜,也有細節。' },
      { emoji: '🤍', title: '白水晶', desc: '負責調和藍色晶石的清晰與柔和,讓整體配戴感更清爽平衡。' },
    ],
    suitedFor: [
      '喜歡清爽海洋色系,想把一點藍色的安定感戴在日常裡',
      '心裡有話但容易先悶著,希望先整理思緒,再慢慢說清楚',
      '想要低調但有細節的手鍊,近看有波光,遠看又很乾淨',
      '偏愛清爽穿搭風格,希望配戴起來輕盈、不厚重',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '溫柔月光把安放心緒、溫柔直覺與月光氣質串在一起,適合喜歡乾淨百搭的人。',
    gentleRecommendation:
    ...
    meanings: [
      { emoji: '🌙', title: '月光石', desc: '在這條裡負責安定與柔和,適合想讓心緒慢慢沉澱的人。' },
      { emoji: '🫧', title: '奶油月光', desc: '把月光感變得更溫潤,讓配戴起來有安靜、柔軟的氣質。' },
      { emoji: '💙', title: '藍月光', desc: '替白色月光感加入溫柔直覺與細緻層次,提醒自己慢慢安放感受。' },
      { emoji: '🤍', title: '白水晶', desc: '負責調和整體月光色系,讓白與藍的光感更乾淨協調。' },
    ],
    suitedFor: [
      '喜歡月光色系與溫柔風格,想要一條不挑衣服的日常百搭手鍊',
      '希望在心緒起伏時提醒自己先停一下,把節奏慢慢放回來',
      '偏愛細緻、乾淨的設計,喜歡低調但會透出光暈的質感',
      '適合想要安靜陪伴感,但不想選太有壓迫感款式的人',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '曦光之詠把招財與自信光芒放得很溫柔,適合喜歡金白色系、但不想太張揚的人。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '🤍', title: '白水晶', desc: '負責調和招財主軸與柔和氣質,讓整體更清透、也更好日常配戴。' },
      { emoji: '💙', title: '藍月光', desc: '替金色能量加入安定與細緻層次,讓明亮感不會太急。' },
      { emoji: '🤎', title: '茶晶', desc: '補上沉穩與落地感,提醒自己慢慢累積也很有力量。' },
    ],
    suitedFor: [
      '想提升招財與自信感,但喜歡明亮不刺眼、溫柔一點的金色',
      '正在整理金錢目標、工作方向或自我價值,想提醒自己值得更多',
      '想要明亮又不張揚的手鍊,可以日常戴,也能在重要日子加一點光',
      '喜歡金白色系搭配,希望財運寓意看起來細緻而不浮誇',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '心語呢喃適合有些感受想慢慢安放的人,把內在整理與重新開始戴成一抹藍白微光。',
    gentleRecommendation:
    ...
    meanings: [
      ...
      { emoji: '💗', title: '安定寓意', desc: '把藍月光與白幽靈的柔和收在一起,帶來安定感的配戴寓意,陪你在日常中放慢節奏。' },
      { emoji: '✨', title: '細緻配件', desc: '用精緻感補足日常穿搭,讓柔軟也可以很有質感。' },
    ],
    suitedFor: [
      '最近有些感受想慢慢整理,但還不一定想急著說出口',
      '希望身邊有一份溫柔陪伴,在低潮或混亂時提醒自己慢慢來',
      '喜歡月光石與白幽靈的清透感,想要一條柔軟、乾淨、不複雜的手鍊',
      '想把重新開始的提醒戴在身上,陪自己一步一步回到節奏裡',
    ],
    story:
  ...
  },
  {
    ...
    meanings: [
      ...
      { emoji: '🛡️', title: '守護界線', desc: '把避小人落到日常界線感,提醒自己該保持距離的人事物,就不要讓它一直消耗你。' },
      { emoji: '✨', title: '沉穩帶光', desc: '黑金礦絲讓深色也保有光澤,不張揚,但仍有自己的存在感。' },
      { emoji: '🌙', title: '深色質感', desc: '低調、好搭,適合想把守護感戴得成熟一點的人。' },
    ],
    suitedFor: [
      '工作或人際環境有點複雜,想加強避小人與界線感',
      '容易被別人的話、情緒或眼光影響,想把注意力慢慢收回自己',
      '喜歡深色、沉穩、有光澤的設計,希望低調但仍然有存在感',
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '雪境溫柔把清透白色、安放心緒與小熊陪伴串在一起,送禮或日常配戴都很乾淨。',
    gentleRecommendation:
    ...
    meanings: [
      { emoji: '🐻', title: '白水晶小熊', desc: '在這條裡負責清透、整理與溫柔陪伴,也讓整體多了可愛記憶點。' },
      { emoji: '🌙', title: '奶油月光石', desc: '補上一份安定與柔和,適合想讓心緒慢慢沉澱的人。' },
      { emoji: '🤍', title: '白水晶', desc: '負責拉亮白色調,讓整條手鍊乾淨百搭,送禮或日常都合適。' },
      { emoji: '❄️', title: '雪境感', desc: '把白水晶與月光石串成安靜雪色,提醒自己可以慢慢來。' },
    ],
    suitedFor: [
      '喜歡白色調與乾淨氣質,想要一條清爽、不挑衣服的手鍊',
      '正在尋找日常送禮款,希望可愛、有質感,也帶一點溫柔寓意',
      '想在手腕上留一份安靜陪伴,提醒自己可以慢慢來',
      '偏愛白水晶小熊與奶油月光的柔白感,不想要太強烈的設計',
    ],
    story:
  ...
  },
  {
    ...
    originalPrice: null,
    tag: null,
    fitSummary: '月映柔光把可愛守護、安放心緒與自信提醒做成有角色感的彩月光手鍊。',
    gentleRecommendation:
    ...
    meanings: [
      { emoji: '🌙', title: '彩月光', desc: '在這條裡負責安定與柔和,每顆光暈都像日常裡的小小提醒。' },
      { emoji: '🐱', title: '五貓守護', desc: '把守護感做成有角色的陪伴,讓安心感不只是抽象寓意,也變得可愛好記。' },
      { emoji: '✨', title: '自信之光', desc: '在柔和之外補上自信提醒,為自己增添一份勇敢前行的力量感。' },
      { emoji: '🍪', title: '純真喜悅', desc: '保留生活裡的小確幸,讓這條不只守護,也有一點輕鬆可愛。' },
    ],
    suitedFor: [
      '喜歡可愛守護系設計,希望手鍊不只是好看,也有角色故事',
      '想要彩月光石的溫柔光暈,每顆看起來都有一點不同個性',
      '希望日常裡多一點安定與自信提醒,但想用輕鬆可愛的方式戴著',
      '想收藏一條有辨識度、有陪伴感,也能自然融入穿搭的手鍊',
    ],
    story:
  ...
  },
  {
    ...
    meanings: [
      ...
      { emoji: '🤍', title: '白水晶', desc: '負責調和深色與月光色,讓整體保有清透感,不顯沉重。' },
      { emoji: '🌹', title: '星花墜飾', desc: '把避小人的守護意象做得更精緻,讓低調設計中保有亮點。' },
    ],
    suitedFor: [
      '想要避小人、守護與界線感,但希望設計看起來精緻而不是厚重',
      '喜歡黑白灰、低調中有細節的手鍊,想讓日常穿搭多一點個性亮點',
  ...
  },
  {
    ...
    meanings: [
      ...
      { emoji: '🤍', title: '白阿塞', desc: '像把心裡的雜訊先沉澱下來,讓金錢目標與日常節奏保留一點留白。' },
  ...
  },
  {
    ...
    suitedFor: [
      ...
      '希望感情、人際與表達都更順一點,也讓自己的溫柔被好好看見',
      '喜歡粉色系與溫柔氣質,想要甜但不膩、日常也能戴的手鍊',
    ],
    story:
