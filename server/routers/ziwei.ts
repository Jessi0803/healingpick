...
**目前問題在哪**：用 2 句說明命盤反映出的核心狀態，明確說出現在容易卡住的原因，避免只堆星曜名詞。

**優勢與容易耗力的地方**：用 2-3 句說明使用者可以運用的優勢，以及可能造成卡住的劣勢或習慣。請放一個生活例子，例如「壓力大時會想太多」「明明不舒服卻先配合別人」。

**可以怎麼改善**：用 2-3 句集中回答使用者的問題，說清楚解決方向。如果問感情，就講關係模式、對方互動中該觀察什麼、下一步怎麼做；如果問工作，就講適合的工作節奏、該把握的機會、該改善的近況；如果問財運，就講金錢習慣、累積方式、近期要注意什麼。

**具體建議**：只給 1-2 條具體建議，必須是使用者今天或這週能做的事。請用白話例子說明，例如「先把想問對方的話寫成一句，不要一次丟很多情緒」。`;
