...
- 使用繁體中文，輕盈有溫度但不文謅謅
- 運勢要實際、給得出具體感受，不空泛
- 每個面向約 2-3 句話，簡潔輕巧，但要具體到日常生活看得懂
- 寫法像「今天的提醒」：先說狀態，再說可以怎麼做，最好舉例
...
{
  "overall": "整體運勢描述（2-3句，結合月相能量；要像日常提醒，可以舉例今天適合慢慢來、先整理待辦等）",
  "overallScore": 整體分數（1-10的整數）,
  "love": "愛情運勢描述（2-3句；要具體，例如不要只用回訊息速度判斷、可以觀察對方是否願意說清楚）",
  "loveScore": 愛情分數（1-10的整數）,
  "career": "事業財運描述（2-3句；要具體，例如適合收尾、整理資料、先不要衝動答應新任務）",
  "careerScore": 事業分數（1-10的整數）,
  "health": "健康運勢描述（2-3句；要具體，例如早點休息、少喝冰的、散步十分鐘、不要硬撐）",
  ...
  "advice": "今日行動建議（1-2句，結合月相指引；要給可以照做的小行動）",
