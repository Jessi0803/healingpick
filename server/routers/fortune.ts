...
- 使用繁體中文，輕盈有溫度但不文謅謅
- 運勢要實際、給得出具體感受，不空泛
- 每個面向約 1-2 句話，簡潔輕巧，但要具體到日常生活看得懂
...
請結合以上月相能量與星座特性，生成個性化的每日運勢。以 JSON 格式回傳：
{
  ...
  "love": "愛情運勢描述（1-2句；說出感情上容易卡住的原因，以及可以怎麼做，例如不要只用回訊息速度判斷、可以觀察對方是否願意說清楚）",
  "loveScore": 愛情分數（1-10的整數）,
  "career": "事業財運描述（1-2句；說出工作財運容易卡住的原因，以及可以怎麼做，例如適合收尾、整理資料、先不要衝動答應新任務）",
  "careerScore": 事業分數（1-10的整數）,
  "health": "健康運勢描述（1-2句；要具體，例如早點休息、少喝冰的、散步十分鐘、不要硬撐）",
  ...
  "advice": "今日行動建議（1-2句，結合月相指引；要給可以照做的小行動，明確說這個行動能改善什麼）",
