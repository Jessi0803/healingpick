...
{
  "overall": "整體運勢描述（結合月相能量；說出今天容易卡住的原因，以及可以怎麼調整，例如先整理待辦）",
  "overallScore": 整體分數（1-10的整數）,
  "love": "愛情運勢描述（說出感情上容易卡住的原因，以及可以怎麼做，例如不要只用回訊息速度判斷、可以觀察對方是否願意說清楚）",
  "loveScore": 愛情分數（1-10的整數）,
  "career": "事業財運描述（說出工作財運容易卡住的原因，以及可以怎麼做，例如適合收尾、整理資料、先不要衝動答應新任務）",
  "careerScore": 事業分數（1-10的整數）,
  "health": "健康運勢描述（說出健康狀態容易卡住的原因，以及可以怎麼做，例如早點休息、少喝冰的、散步十分鐘、不要硬撐）",
  "healthScore": 健康分數（1-10的整數）,
  "luckyColor": "幸運色（單一顏色名稱，與月相或星座元素相關）",
  "luckyNumber": 幸運數字（1-99的整數）,
  "crystal": "推薦水晶名稱（與月相能量相呼應）",
  "crystalReason": "推薦該水晶的原因（1句話，提及月相，白話說明它今天適合陪伴什麼狀態）",
  "advice": "今日行動建議（結合月相指引；要給可以照做的小行動，明確說這個行動能改善什麼）",
  "moonPhase": "${moonPhase.name}",
  "moonSymbol": "${moonPhase.symbol}"
}`;
