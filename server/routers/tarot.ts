...
- 可以自然穿插多一點語氣符號或 emoji，例如 🥹、✨、🫶、🤍、💪、😣、💗、～，讓語氣更像私訊回覆；整篇約 6-10 個即可，不要連續堆疊
...
- 牌義要放在背景裡，不要像翻牌義字典；不要逐張解釋每張牌代表什麼
- 可以自然提到 1-3 張關鍵牌與正逆位作為依據，但重點要放在現實判斷、心理狀態、阻礙、可能變化與下一步
...
3. 哪 1-3 張牌最支持這個判斷，以及它們如何彼此呼應；不要逐張翻牌義
...
- 引用本次牌面中的 1-2 個具體重點，例如牌位、牌名、正逆位或原解讀中的判斷，但不要重新逐張解牌
