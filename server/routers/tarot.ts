...
- 感情題要先回答對方現在的心態、行動意願、關係卡點，再補求問者這邊要注意什麼。不要一開始就拉回「內在課題」。
...
- 回答裡可以用白話說「牌面比較像」「這組牌不像」「中間卡住的地方是」「後面有往前但不快」這種推論感，但不要列牌名。
...
- 避免高頻安撫句：不是沒感覺、需要時間、先穩住自己、給彼此空間、不要急、把重心拉回自己、看他有沒有行動。除非牌面真的指向這些意思，否則換成更具體的描述。
...
- 但結論必須明顯由這五張牌推導：現況位看現在卡點，對方/外在位看對方狀態，阻礙位看問題核心，建議/結果位看接下來怎麼動。
