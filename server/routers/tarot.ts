...
- 請明顯增加語氣符號和 emoji，例如 🥹、✨、🫶、🤍、💪、😣、💗、😌、💞、～、！；整篇至少 10 個 emoji、至少 5 個「！」、至少 4 個「～」，但不要連續堆疊同一種符號
- 口氣要像私訊聊天，允許更常出現「～」和「！」，例如「有機會！」、「不是沒有感覺～」、「這點很重要！」；不要每句都用，也不要變成浮誇喊話
...
- 請自然穿插 emoji、驚嘆號和波浪號，例如 🥹、✨、🫶、🤍、💪、😣、💗、😌、💞、～、！；整篇至少 5 個 emoji、至少 3 個「！」、至少 2 個「～」，不要連續堆疊
