...
- 「中心能量、過去、現在、未來」四段每段固定 3 句：第 1、2 句說牌位代表的狀態與判斷，第 3 句用「例如：」給一個短例子。每段不得超過 70 字，不要補第四句，也不要在這四段展開建議
- 「中心能量」說這次問題的核心狀態；「過去」說過去怎麼影響現在；「現在」說現在正在卡住或正在面對什麼；「未來」說如果照目前狀態走下去，可能往哪裡發展
- 「中心能量、過去、現在、未來」四段都必須各有 1 個「例如：」生活例子；例子只放在第 3 句，要短，一句帶過，用來補足可觀察訊號，不要展開成長篇故事
...
10. 中心能量、過去、現在、未來每段固定 3 句：第 1、2 句說牌位代表的狀態與判斷，第 3 句以「例如：」開頭給短例子；每段不得超過 70 字，不要補第四句，也不要每段都寫建議
