...
- 「中心能量、過去、現在、未來」這四段各控制在 2-3 句、約 55-75 字；每段只講一個重點：先說牌位代表的狀態，再補一個和問題相關的具體例子。不要在這四段展開建議
- 「中心能量」說這次問題的核心狀態；「過去」說過去怎麼影響現在；「現在」說現在正在卡住或正在面對什麼；「未來」說如果照目前狀態走下去，可能往哪裡發展
- 「中心能量、過去、現在、未來」四段都必須各有 1 個「例如：」生活例子；例子要短，一句帶過，用來補足可觀察訊號，不要展開成長篇故事
...
10. 中心能量、過去、現在、未來各用 2-3 句、約 55-75 字講完，只保留一個主要判斷和一個「例如：」短例子，不要每段都寫建議
